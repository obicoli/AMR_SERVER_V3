...
class ProductController extends Controller
{
    ...
    public function index($uuid=null,$practice_uuid=null){

        $http_resp = $this->http_response['200'];
        if( $uuid && $practice_uuid ){
            ...
            $http_resp['results'] = [];//$this->productItem->transform_product_item($product,null,null,$parentPractice);
        }else{
            $products = $this->product->all();
            $http_resp['results'] = $this->product->transform_collection($products);
        }
