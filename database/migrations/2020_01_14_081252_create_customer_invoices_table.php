...
class CreateCustomerInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection(Module::MYSQL_CUSTOMER_DB_CONN)->dropIfExists('customer_invoices');
        Schema::connection(Module::MYSQL_CUSTOMER_DB_CONN)->create('customer_invoices', function (Blueprint $table) {
            $table->increments('id');
