...
class CreateCustomerSalesReceiptsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection(Module::MYSQL_CUSTOMER_DB_CONN)->dropIfExists('customer_sales_receipts');
        Schema::connection(Module::MYSQL_CUSTOMER_DB_CONN)->create('customer_sales_receipts', function (Blueprint $table) {
            $table->increments('id');
