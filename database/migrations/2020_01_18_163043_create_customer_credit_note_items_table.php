...
class CreateCustomerCreditNoteItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection(Module::MYSQL_CUSTOMER_DB_CONN)->dropIfExists('customer_credit_note_items');
        Schema::connection(Module::MYSQL_CUSTOMER_DB_CONN)->create('customer_credit_note_items', function (Blueprint $table) {
            $table->increments('id');
