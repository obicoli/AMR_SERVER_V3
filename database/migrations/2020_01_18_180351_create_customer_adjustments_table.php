...
class CreateCustomerAdjustmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection(Module::MYSQL_CUSTOMER_DB_CONN)->dropIfExists('customer_adjustments');
        Schema::create('customer_adjustments', function (Blueprint $table) {
            ...
            $table->enum('effect',['Increase','Decrease'])->default('Increase');
