...
.k-textarea-wrapper.k-state-focused > .k-label {
...
.k-rtl .k-multiselect-wrap .k-multiselect-wrap[dir="rtl"] .k-button,
[dir="rtl"] .k-multiselect-wrap .k-button {
  margin-left: 4px;
  margin-right: 0;
}
.k-rtl .k-multiselect-wrap .k-multiselect-wrap[dir="rtl"] .k-button .k-select,
[dir="rtl"] .k-multiselect-wrap .k-button .k-select {
  margin-left: -0.2em;
  margin-right: 0.5em;
}
...
[dir="rtl"] .k-checkbox-legacy-label::before,
.k-rtl .k-checkbox-legacy-label::after,
[dir="rtl"] .k-checkbox-legacy-label::after {
  left: auto;
  right: 0;
}
.k-checkbox-legacy-label::before {
...
.k-checkbox-legacy:disabled + .k-checkbox-legacy-label::before {
  border-color: #b0b0b0;
}
.k-checkbox-legacy:checked:disabled + .k-checkbox-legacy-label::before,
.k-checkbox-legacy:indeterminate:disabled + .k-checkbox-legacy-label::before {
  border-color: #b0b0b0;
  background-color: #b0b0b0;
}
.k-checkbox-legacy:checked:disabled + .k-checkbox-legacy-label::after,
.k-checkbox-legacy:indeterminate:disabled + .k-checkbox-legacy-label::after {
  color: #fff;
}
.k-checkbox:disabled + .k-checkbox-label {
  color: rgba(0, 0, 0, 0.54);
...
.k-checkbox-legacy-label .k-ripple-blob {
  opacity: 0.2;
  background-color: #3f51b5;
}
.k-radio {
...
.k-radio-legacy:disabled + .k-radio-legacy-label::before {
  border-color: #b0b0b0;
}
.k-radio-legacy:checked:disabled + .k-radio-legacy-label::before {
  border-color: #b0b0b0;
}
.k-radio-legacy:checked:disabled + .k-radio-legacy-label::after {
  color: #b0b0b0;
}
...
.k-radio-legacy-label .k-ripple-blob {
  opacity: 0.2;
}
.k-menu {
  display: -ms-flexbox;
