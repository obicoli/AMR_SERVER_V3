<template>
    ...
    <form @submit.prevent="add_store">

        <div class="modal-content">
            <div class="modal-header">
                <h4 v-if="user_mode==='Create'" class="cl-grey"><i class="fa fa-plus-circle"></i> Add New Store:</h4>
                <h4 v-if="user_mode==='Edit'" class="cl-grey"><i class="fa fa-edit"></i> Edit Store:</h4>
            ...
            <div  class="modal-body">
                ...
                <div class="row form-group mg-bottom-10">
                    <div class="col-lg-3 col-md-3 col-sm-3 label-txt-right padding-right-0">
                        <label class="fs-14 cl-888">Store name:<span class="cl-red">*</span></label>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-7">
                        <input type="text" required v-model="form.name" class="form-control product-entry-input-field">
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            add_store: function () {
                ...
                post(AppInfo.app_data.server_domain+'/api/practices/stores',this.form)
                    .then((res) => {
