<template>
    ...
    <form @submit.prevent="save_currency">
        <div class="modal-content">
            <div class="modal-header">
                <h4 v-if="user_mode==='Create'" class="cl-grey"><i class="fa fa-plus-circle"></i> Add Currency:</h4>
                <h4 v-if="user_mode==='Edit'" class="cl-grey"><i class="fa fa-edit"></i> Edit Currency:</h4>
            ...
            <div class="modal-body">
                <div class="row form-group mg-bottom-10">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7">
                        <input type="text" v-model="form.name" placeholder="e.g Shilling" required v-bind:class="{'form-control product-entry-input-field':true,'attended_field':form.name}">
                    </div>
                </div>
                <div class="row form-group mg-bottom-10">
                    <div class="col-lg-3 col-md-3 col-sm-3 label-txt-right padding-right-0">
                        <label class="fs-14 cl-888">Symbol:</label>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-7">
                        <input type="text" v-model="form.slug" placeholder="e.g KES" required v-bind:class="{'form-control product-entry-input-field':true,'attended_field':form.slug}">
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7">
                        <select required v-model="form.status" v-bind:class="{'form-control product-entry-input-field height-32':true,'attended_field':form.status}" data-live-search="true" style="width: 100%;">
