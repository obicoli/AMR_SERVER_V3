    ...
    <form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="cl-grey fw-600 fs-16"><i class="fa fa-check-circle"></i> Sales Charges&Tax:</h4>
            </div>
                ...
                <div class="bg-white border-top-0 border-bottom-0 border-radius-0">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7">
                            <input type="text" name="product_name" class="form-control product-entry-input-field">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-lg-3 col-md-3 col-sm-3 label-txt-right padding-right-0">
                            <label class="fs-14 cl-888">Amount in (%):</label>
                        </div>
                        <div class="col-lg-7 col-md-7 col-sm-7">
                            <input type="number" class="form-control product-entry-input-field">
                        </div>
                    </div>
                </div>
            </div>
