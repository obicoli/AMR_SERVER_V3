        ...
        <div class="wp-content">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="settings-header shadowed main-heading bg-foo">Billing | Bill List:</div>
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                ...
                                <div class="width-100-pc padding-left-20 padding-right-20 padding-top-20 padding-bottom-20 mg-bottom-30">
                                    ...
                                    <div  class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                                        <button data-toggle="modal" data-target="#add_bill_modal" type="button" class="btn combo-button primary">Add Bill</button>
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu right-0" aria-labelledby="btnGroupDrop">
                                                ...
                                                <a class="dropdown-item"><i class="fa fa-file-excel-o"></i> Export</a>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        name: "Index",
        components: {TopNavBar, SideBar,SideBarBill,Loading,DeleteStuffModal,BillModal},
        data(){
            return {
                employees_list: [],
