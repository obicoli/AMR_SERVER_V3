                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo min-height-100-vh">
                            <side-bar-accounts :scrollable="false" :width="true" :transparent="true" :title="'Accounts'" :active_num="'coa'"></side-bar-accounts>
                        </div>
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                ...
                                <div class="page-content bg-white min-height-100-vh padding-10">
                                    <div class="mg-bottom-30 universal-grid padding-left-20 padding-right-20 max-width-1000" role="grid">
                                        <report-heading :report_name="'Chart of Accounts'" :as_at="'Date goes here'" :facility_name="facility_name"></report-heading>
                                        ...
                                        <div class="width-40-pc padding-left-20 padding-top-20 padding-bottom-20 pull-right">
                                            <div  class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                                                <button data-toggle="modal" data-target="#coa_modal" type="button" class="btn combo-button combo-default">+ New</button>
                                ...
                                <account-modal v-if="page_loaded" :initial_url="initialUrl" :ACCOUNTING="ACCOUNTING" :main_accounts="company_main_coa" v-on:successCreated="loadCoa('hide')" :user_mode="'Create'" :practice_id="practice_id" :accounting_initials="accounting_initials" :modal_id="'coa_modal'" :title="'Account'"></account-modal>
                            </div>
...
<script>
    ...
    import {CHART_OF_ACCOUNTS,ACCOUNTS_INITIALS} from "../../../../../router/api_routes";
    import SearchItemFormControl from "../../partials/modals/product/SearchItemFormControl";
    export default {
        name: "Index",
        components: {TopNavBar,SideBar,SideBarAccounts,ProcessingOverlay,SearchItemFormControl,CommonLink,AccountModal,ConfirmModal,ReportHeading},
        data(){
            return {
        ...
        methods: {
            ...
            loadCoa(load_progress="show"){
                ...
                .then((res) => {
                    if(res.data.status_code === 200) {
                        ...
                        for (let index = 0; index < this.chart_of_accounts.length; index++) {
                            const element = this.chart_of_accounts[index];
                            if(!element.is_sub_account){
                                this.company_main_coa.push(element);
                            }
                        }
            ...
            // loadInitials(load_progress="show"){
            //     this.progress_overlay = load_progress;
        ...
        mounted() {
            ...
            this.accounting_initials = Auth.getAccounting()
            //console.info(this.accounting_initials);
            this.loadCoa();
        }
    }
