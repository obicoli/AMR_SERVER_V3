                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <!-- <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo min-height-100-vh">
                            <side-bar-statement :scrollable="false" :width="true" :transparent="true" :title="'Statements'" :active_num="'balance_sheet'"></side-bar-statement>
                        </div> -->

                        <div class="col-md-10 col-lg-10 col-sm-10 padding-right-0 padding-left-0 bg-foo min-height-100-vh">

                            <report-filter :title="'Balance Sheet Report'"></report-filter>
                                ...
                                <div class="page-content bg-white min-height-100-vh padding-10">
                                    <div class="mg-bottom-30 universal-grid padding-left-20 padding-right-20 max-width-1000" role="grid">
                                        <div class="padding-top-10 padding-bottom-10 mg-top-30 padding-left-20 padding-right-20 reportArea">
                                            <report-heading v-if="page_loaded" :report_name="'Balance Sheet'" :as_at="as_at" :facility_name="facility_name"></report-heading>
                                            <bs-view v-if="page_loaded" :ledgers="ledgers" :ACCOUNTING="ACCOUNTING"></bs-view>
                                        </div>
...
<script>
    ...
    import BsView from "./partials/BsView";
    ...
    import {ACCOUNTS_BALANCE_SHEET,ACCOUNTS_INITIALS} from "../../../../../router/api_routes";
    export default {
        name: "TrailBalance",
        components: {TopNavBar,SideBar,SideBarStatement,ProcessingOverlay,CommonLink,ReportFilter,BsView,ReportHeading},
        data(){
            return {
                initialUrl: ACCOUNTS_BALANCE_SHEET,
