                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <!-- <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo min-height-100-vh">
                            <side-bar-statement :scrollable="false" :width="true" :transparent="true" :title="'Statements'" :active_num="'ledger'"></side-bar-statement>
                        </div> -->
                        ...
                        <div class="col-md-10 col-lg-10 col-sm-10 padding-right-0 padding-left-0 bg-foo min-height-100-vh">
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                ...
                                <div class="page-content bg-white min-height-100-vh padding-10">
                                    <div class="mg-bottom-30 universal-grid padding-left-20 padding-right-20 max-width-1100" role="grid">
                                        <div class="padding-top-10 padding-bottom-10 mg-top-30 padding-left-20 padding-right-20 reportArea">
                                            <report-heading v-if="page_loaded" :report_name="'General Ledger'" :as_at="as_at" :facility_name="facility_name"></report-heading>
                                            <ledger-view v-if="page_loaded" :ledgers="ledgers" :ACCOUNTING="ACCOUNTING"></ledger-view>
                                        </div>
...
<script>
    ...
    import LedgerView from "./partials/LedgerView";
    ...
    import {ACCOUNTS_LEDGER,ACCOUNTS_INITIALS} from "../../../../../router/api_routes";
    export default {
        name: "Journal",
        components: {TopNavBar,SideBar,SideBarStatement,ProcessingOverlay,CommonLink,ReportFilter,LedgerView,ReportHeading},
        data(){
            return {
                initialUrl: ACCOUNTS_LEDGER,
