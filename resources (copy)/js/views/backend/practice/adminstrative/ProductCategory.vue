        ...
        <div class="wp-content">
            <div class="row">
                <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo min-height-100-vh">
                    <side-bar-settings :scrollable="true" :width="true" :transparent="true" :category="true"></side-bar-settings>
                </div>
                <div class="col-md-10 col-lg-10 col-sm-10 padding-left-0">
                    <div class="settings-header main-heading bg-foo">Settings | Product Category</div>
...
<script>
    ...
    export default {
        ...
        components: {TopNavBar, SideBar,SideBarSettings},
        data(){
            return {
                current_branch: {},
                initial_url: '/api/products/',
                practice_id: '',
                processing: false,
                page_loaded: false,
            }
