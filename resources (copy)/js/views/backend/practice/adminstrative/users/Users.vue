                                                            ...
                                                            <table class="table itemized x-panel">
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="(company_user, user_index) in company_users" :key="'users'+user_index">
                                                                        ...
                                                                        <user-modal :modal_id="'edit_user_'+user_index" :form_data="company_user" :user_mode="'Edit'" :user_api="PRACTICE_USERS_API" :hr_roles="roles" :companies="companies" :departments="departments" :warehouses="warehouses" :subwarehouses="subwarehouses" :title="'Edit User'"></user-modal>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
