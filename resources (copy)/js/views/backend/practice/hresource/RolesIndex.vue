                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull pull-right app-header width-50-pc text-right padding-right-30">
                                    <common-links-user :active_link="'roles'"></common-links-user>
                        ...
                        <div class="col-md-10 col-lg-10 col-sm-10 padding-right-0 padding-left-0 bg-foo min-height-100-vh">
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                ...
                                <div class="width-100-pc padding-left-20 padding-right-20 padding-top-20 padding-bottom-20 mg-bottom-30">
                                    <search-database-form-control v-if="page_ready" :placeholder="'search by name'" :field_wdth="250" :rounded_px="10"></search-database-form-control>
                                    <div  class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                                        <button :disabled="perm_form.role_id===''" @click="saveRole" type="button" class="btn combo-button combo-default"> Save</button>
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop">
                                                <a class="dropdown-item" data-toggle="modal" data-target="#add_role_modal"> Add Role</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        name: "RolesIndex",
        components: {TopNavBar, SideBar,CommonLinksUser,SideBarRole,ProcessingOverlay,SearchDatabaseFormControl,DeleteStuffModal,AddRole},
        data(){
            return {
                branch_id: '',
