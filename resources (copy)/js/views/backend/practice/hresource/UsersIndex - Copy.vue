                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                ...
                                <div class="page-content bg-white min-height-100-vh padding-10">
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc padding-left-20 padding-right-20" role="grid">
                                        <table class="user-table table-striped" role="presentation">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>Email</th>
                                ...
                                <new-user-modal v-if="page_ready" :modal_id="'userModal'" :hr_roles="hr_roles" :practices="practices" :departments="departments" :practice_id="practice_id" :title="'Add a new user'" :user_mode="'Create'" v-on:userAdded="loadUsers"></new-user-modal>
