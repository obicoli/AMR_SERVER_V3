                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height-wc">
                            <side-bar-inventory v-if="page_ready" :customer="true" :scrollable="true" :width="true" :transparent="true" :active_num="'credit_notes'" :title="'Invoices'"></side-bar-inventory>
                        </div>
                                            ...
                                            <div class="padding-right-10 min-height-30 width-100-pc">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2'">
                                                        ...
                                                        <a class="dropdown-item pointer-cursor">Credit Note#</a>
                                                        <a class="dropdown-item pointer-cursor">Customer Name</a>
                                                        <a class="dropdown-item pointer-cursor">Amount</a>
                                                        <a class="dropdown-item pointer-cursor">Balance</a>
                                                        <a class="dropdown-item pointer-cursor">Next Invoice Date</a>
                                                        <a class="dropdown-item pointer-cursor">Amount</a>
                                                        <a class="dropdown-item separator"></a>
                                                        <a class="dropdown-item pointer-cursor">Import Credit Notes</a>
                                                        <a class="dropdown-item pointer-cursor">Import Applied Credit Notes</a>
                                                        <a class="dropdown-item pointer-cursor">Import Refunds</a>
                                                        <a class="dropdown-item separator"></a>
                                                        <a class="dropdown-item pointer-cursor">Export Credit Notes</a>
                                                        <a class="dropdown-item pointer-cursor">Export Applied Credit Notes</a>
                                                        <a class="dropdown-item pointer-cursor">Export Refunds</a>
                                                        <a class="dropdown-item separator"></a>
                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                <p class="fs-20">Credit Notes</p><br>
                                                <small class="fs-14 cl-777">Refunds and Credits.</small><br><br>
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-20 padding-bottom-10">
                                                ...
                                                <ul class="custom-list">
                                                    <li class="title">In the Credit Notes section, you can:</li>
                                                    <li>Issue refunds and credits to your customers and apply them to invoices</li>
                                                    <li>Record and manage excess payments as credits.</li>
                                                </ul>
                                            </div>
