                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height">
                            <side-bar-customer :scrollable="false" :width="true" :transparent="true" :title="'Payments Received'" :active_num="'payments'"></side-bar-customer>
                        </div>
                            ...
                            <div class="estimate-list width-100-pc content-calculated-height">
                                <div class="estimate-list-head">
                                    ...
                                    <div class=" width-50-pc float-right">
                                        ...
                                        <payment-modal :modal_id="'modal_id_invoice'" :modal_title="'Receive Payment'"></payment-modal>
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        name: "Index",
        components: {TopNavBar,SideBar,ConfirmModal,PaginateTemplate,CustomerModal,EstimateView,PaymentModal,
