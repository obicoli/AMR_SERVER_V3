                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height">
                            <side-bar-customer :scrollable="false" :width="true" :transparent="true" :title="'Sales Orders'" :active_num="'sales_orders'"></side-bar-customer>
                        </div>
...
<script>
    ...
    import EstimateView from './partials/SalesOrderView'
