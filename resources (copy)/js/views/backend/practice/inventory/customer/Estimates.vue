                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height-wc">
                            <side-bar-inventory v-if="page_ready" :customer="true" :scrollable="true" :width="true" :transparent="true" :active_num="'estimates'" :title="'Estimates'"></side-bar-inventory>
                        </div>
                                            ...
                                            <div class="padding-right-10 min-height-30 width-100-pc">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2'">
                                                        ...
                                                        <a class="dropdown-item pointer-cursor">Estimate Number</a>
                                                        <a class="dropdown-item pointer-cursor">Customer Name</a>
                                                        <a class="dropdown-item pointer-cursor">Amount</a>
                                                        <a class="dropdown-item separator"></a>
                                                        <a class="dropdown-item pointer-cursor">Import Estimates</a>
                                                        <a class="dropdown-item pointer-cursor">Export Estimates</a>
                                                        <a class="dropdown-item separator"></a>
                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                <p class="fs-20">Estimates</p><br>
                                                <small class="fs-14 cl-777">With estimates, give your customers an offer they can’t refuse!</small><br><br>
                                                <a data-toggle="modal" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-amref cl-white txt-uppercase">Create New Estimate</a>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-20 padding-bottom-10">
                                                ...
                                                <ul class="custom-list">
                                                    <li class="title">In the Estimates section, you can:</li>
                                                    <li>Create & Customize your estimate</li>
                                                    <li>Convert an accepted estimate into an invoice</li>
                                                    <li>Know when an estimate has been viewed, accepted, or declined</li>
                                                </ul>
                                            </div>
