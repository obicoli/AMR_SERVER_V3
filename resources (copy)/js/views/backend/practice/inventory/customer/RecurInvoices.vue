                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height-wc">
                            <side-bar-inventory v-if="page_ready" :customer="true" :scrollable="true" :width="true" :transparent="true" :active_num="'recur_invoices'" :title="'Invoices'"></side-bar-inventory>
                        </div>
                                        ...
                                        <div v-else class="btn-group" role="group" aria-label="Button group">
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2_1'">
                                                    ...
                                                    <a class="dropdown-item pointer-cursor">Stopped</a>
                                            ...
                                            <div class="padding-right-10 min-height-30 width-100-pc">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2'">
                                                        ...
                                                        <a class="dropdown-item pointer-cursor">Invoices#</a>
                                                        <a class="dropdown-item pointer-cursor">Customer Name</a>
                                                        <a class="dropdown-item pointer-cursor">Profile Name</a>
                                                        <a class="dropdown-item pointer-cursor">Last Invoice Date</a>
                                                        <a class="dropdown-item pointer-cursor">Next Invoice Date</a>
                                                        <a class="dropdown-item pointer-cursor">Amount</a>
                                                        <a class="dropdown-item separator"></a>
                                                        <a class="dropdown-item pointer-cursor">Import Recurring Invoives</a>
                                                        <a class="dropdown-item pointer-cursor">Export Recurring Invoives</a>
                                                        <a class="dropdown-item separator"></a>
                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                <p class="fs-20">Create. Set. Repeat.</p><br>
                                                <small class="fs-14 cl-777">Set up a profile to periodically create and send invoices to your customers.</small><br><br>
                                                <a data-toggle="modal" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-amref cl-white txt-uppercase">New Recuring Invoice</a>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-20 padding-bottom-10">
                                                ...
                                                <ul class="custom-list">
                                                    <li class="title">In the Recurring Invoices section, you can:</li>
                                                    <li>Automate sending of repeat invoices based on a schedule of your choice</li>
                                                    <li>Automatically or manually charge your customer’s card</li>
                                                    <li>Send email notification to customers in case of payment failure</li>
                                                </ul>
                                            </div>
