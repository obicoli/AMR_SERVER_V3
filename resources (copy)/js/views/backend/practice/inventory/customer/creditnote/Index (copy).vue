                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                                ...
                                                <div class="width-100-pc float-left mg-top-30 mg-bottom-50">
                                                    <div v-if="page_ready && customer_invoices.length===0" class="width-100-pc float-left mg-top-10 mg-bottom-50 text-center">
                                                        <div class="width-100-pc text-center float-left">
                                                            ...
                                                            <a data-toggle="modal" data-target="#create_credit_note_modal" class="btn btn-secondary banking-process-amref">New Credit Note</a>
                                                        </div>
                                                        ...
                                                        <div class="width-25-pc float-right mg-bottom-15">
                                                            <div class="btn-group float-right" role="group">
                                                                ...
                                                                <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2_1'">
                                                                    ...
                                                                    <a data-toggle="modal" data-target="#create_credit_note_modal" class="dropdown-item pointer-cursor">Credit Note</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-12 col-lg-12 padding-right-0 border-bottom">
                                                ...
                                                <credit-note-modal v-if="page_ready" :modal_title="'New Credit Note'" :customers="customers" :modal_id="'create_credit_note_modal'" :payment_terms="payment_terms" :filters="filters" :taxations="taxations" :currency="currency" :sales_order_api="CUSTOMERS_SALES_ORDERS_API" @create-salesorder-event="loadSalesorders(true)"></credit-note-modal>
...
<script>
    ...
    export default {
        ...
        ProcessingOverlay,InvoiceModal,CreditNoteModal},
        data(){
            return {
