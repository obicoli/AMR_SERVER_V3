                            ...
                            <div class="estimate-list width-100-pc content-calculated-height-50">
                                <div class="estimate-list-head">
                                        ...
                                        <div  class="btn-group" role="group" aria-label="Button group">
                                            <div v-if="selected_bills.length" class="btn-group" role="group">
                                                <a :id="'btnGroupDrop2_1'" class="dropdown-toggle pointer-cursor fw-600 cl-444 fs-14" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    {{selected_bills.length}} Credit note selected
                                                </a>
                                    ...
                                    <div class="width-20-pc float-right">
                                        <button type="button" data-toggle="modal" title="New Credit Note" data-target="#new_credit_note_modal" class="float-right btn btn-secondary banking-process-amref">+</button>
                                    </div>
                                </div>
                            ...
                            <div class="box box-primary bg-white border-top-0 mg-bottom-0 content-calculated-height-50 border-bottom-0 no-shadowed">
                                 <div  class="width-100-pc action-header padding-left-20 padding-top-10 padding-bottom-10">
                                    ...
                                    <div class="float-right width-80-pc text-right padding-right-30">
                                        ...
                                        <router-link :to="CREDIT_NOTES_URL" tag="i" class="btn btn-default btn-inventory btn-gray"><i class="fa fa-arrow-circle-left"></i> Back</router-link>
                                    </div>
...
<script>
    ...
    import {CUSTOMERS_SALES_RECEIPT_API,CUSTOMERS_CREDIT_NOTES_API,CUSTOMERS_API,SUPPLIER_PAYMENTS_API,SUPPLIER_TERMS_API,BANKING_ACCOUNTS_URL,CHART_OF_ACCOUNTS,PRODUCT_ITEMS_URL,PRODUCT_TAX_URL,SUPPLIER_URL,ACCOUNTS_ACCOUNT,PRACTICES_API,SUPPLIER_PO_URL,SUPPLIER_BILL_ASSETS_API, CUSTOMERS_ESTIMATES_API} from '../../../../../../router/api_routes';
    ...
    export default {
        ...
        RibbonMaker,CompanyLogo,FileAttachModal,CashReceiptPreview,CopyRight,JournalRender,CreditNoteModal},
        data(){
            return {
                curr_tab: 0,
                ...
                initial_credit_note_api: CUSTOMERS_CREDIT_NOTES_API+'/'+this.$route.params.uuid,
                ...
                CREDIT_NOTES_URL: INVENTORY_WEB_ROUTES.SALES.CREDIT_NOTES,
                sales_receipts:[],
            }
        },
        ...
        methods: {
            ...
            addComment(){
                ...
                let api_ = CUSTOMERS_CREDIT_NOTES_API+'/'+this.bill.id+'?action='+FORM_ACTIONS.COMMENT;
            ...
            setSrp(bill_obj,index=-1){
                ...
                this.initial_credit_note_api = CUSTOMERS_CREDIT_NOTES_API+'/'+bill_obj.id;
                this.loadCreditNote();
            },
            ...
            log_print(element_id,msg){
                this.printing = true;
                let api_ = CUSTOMERS_CREDIT_NOTES_API+'/'+this.bill.id+'?action='+FORM_ACTIONS.PRINT;
                let form_ = {};
                post(api_,form_)
                    .then((res) => {
                        if(res.data.status_code === 200) {
            ...
            loadCreditNote(show_progress=false){
                this.is_initializing = show_progress;
                get(this.initial_credit_note_api)
                .then((res) => {
                    if(res.data.status_code === 200) {
