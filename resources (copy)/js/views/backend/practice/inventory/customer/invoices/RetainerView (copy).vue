                                        ...
                                        <tbody v-for="(customer_invoic,index) in customer_invoices" v-bind:class="{'active':active_po===index}" :key="'po_list_'+index">
                                            ...
                                            <tr class="child">
                                                ...
                                                <td style="width:35%" class="text-right">
                                                    ...
                                                    <a @click="setPo(customer_invoic,index)" v-else="" class="txt-uppercase fs-12 fw-600 cl-787887">Pending</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="box box-primary bg-white border-top-0 mg-bottom-0 content-calculated-height-50 border-bottom-0 no-shadowed">
                                <div  class="width-100-pc action-header padding-left-20 padding-top-10 padding-bottom-10">
                                    ...
                                    <div class="float-right width-80-pc text-right padding-right-30">
                                        ...
                                        <router-link :to="INVOICES_URL" tag="i" class="btn btn-default btn-inventory btn-gray"><i class="fa fa-arrow-circle-left"></i> Back to Invoices</router-link>
                                    </div>
                                ...
                                <div class="page-content bg-white padding-left-0 height-scrollable">
                                 ...
                                 <bill-modal v-if="page_ready" :taxations="taxations" :inventories="inventories" :accounts="accounts" :bank_accounts="bank_accounts" :filters="filters" :billable="false" :payment_terms="payment_terms" :currency="currency" :bill_api="CUSTOMERS_RETAINER_INVOICES_API" :billable_type="'PO'" :suppliers="suppliers" :order="bill" :modal_id="'new_bill_id'" :modal_title="'New Bill'" @create-bill-event="loadInvoices"></bill-modal>
                                 ...
                                 <change-status v-if="page_ready" @change-status-event="loadInvoices(true)" :modal_title="'Change Status'" :item_url="CUSTOMERS_RETAINER_INVOICES_API+'/'+bill.id" :modal_id="'change_status_modal'"></change-status> -->
...
<script>
    ...
    import {CUSTOMERS_INVOICES_API,CUSTOMERS_RETAINER_INVOICES_API,BANKING_ACCOUNTS_URL,PRODUCT_TAX_URL,CUSTOMERS_SALES_ORDERS_API,CUSTOMERS_ESTIMATES_API, CUSTOMERS_API, CUSTOMERS_TERMS_API} from '../../../../../../router/api_routes';
