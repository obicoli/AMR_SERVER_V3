...
<script>
    ...
    import {SUPPLIER_BILL_URL,SUPPLIER_PAYMENTS_API,SUPPLIER_TERMS_API,BANKING_ACCOUNTS_URL,CHART_OF_ACCOUNTS,PRODUCT_ITEMS_URL,PRODUCT_TAX_URL,SUPPLIER_URL,ACCOUNTS_ACCOUNT,PRACTICES_API,SUPPLIER_PO_URL,SUPPLIER_BILL_ASSETS_API, CUSTOMERS_ESTIMATES_API} from '../../../../../../router/api_routes';
    ...
    export default {
        name: "BillView",
        components: {TopNavBar,SideBar,PaginateTemplate,PoModal,BillModal,ConfirmModal,SendMail,AuditTimeline,PaymentReceiptPreview,
