                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 col-lg-10 padding-right-0 border-bottom">
                                                <div :hidden="estimates.length===0 && default_filter==='All'" class="width-100-pc float-left">
                                                ...
                                                <div class="width-100-pc float-left mg-top-30 mg-bottom-50">
                                                    <div v-if="page_ready && estimates.length===0" class="width-100-pc float-left mg-top-10 mg-bottom-50 text-center">
                                                        <div class="width-100-pc text-center float-left">
                                                            <a class="fs-15 txt-uppercase cl-444 fw-600">Estimates</a><br>
                                                            <small class="fs-13 cl-777">With estimates, give your customers an offer they can’t refuse!</small><br><br>
                                                            <a data-toggle="modal" data-target="#new_estimate_modal" class="btn btn-secondary banking-process-amref">Create New Estimate</a>
                                                        </div>
                                                        <div class="width-100-pc text-center float-left mg-top-20">
                                                            <img src="/assets/icons/dashboard/estimate_cycle.png" class=" mg-bottom-20">
                                                        </div>
                                                    </div>
                                                    <div v-else-if="page_ready && estimates.length>0" class="width-100-pc float-left mg-top-30 mg-bottom-50">
                                                        ...
                                                        <div id="po_list_id_0" class="width-100-pc float-left">
                                                            <table class="table banking-transaction table-hover mg-bottom-5">        
                                                                ...
                                                                <tbody v-for="(estimate,index) in estimates" :key="'chart_of_accounts_'+index">
                                                                    <tr>
                                                                        <td class="somepad">
                                                                            <input :disabled="is_initializing || processing" v-model="selected_estimates" type="checkbox" class="pointer-cursor" :value="estimate.id">
                                                                        </td>
                                                                        <router-link tag="td" :to="QUOTE+'/'+estimate.id+'/view'" class="somepad pointer-cursor">
                                                                        ...
                                                                        <router-link tag="td" :to="QUOTE+'/'+estimate.id+'/view'" class="somepad pointer-cursor text-right fw-600">
                                                        ...
                                                        <div class="width-20-pc float-left">
                                                            <div class="btn-group" role="group">
                                                                <button :disabled="is_initializing || processing || selected_estimates.length===0 " :id="'btnGroupDrop2_1'" class="dropdown-toggle btn btn-secondary banking-process-amref" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    <span v-if="selected_estimates.length">{{selected_estimates.length}} estimates selected</span>
...
<script>
    ...
    import {CUSTOMERS_ESTIMATES_API,PRODUCT_TAX_URL,CHART_OF_ACCOUNTS, CUSTOMERS_API,CUSTOMERS_SALES_ORDERS_API,CUSTOMERS_TERMS_API} from '../../../../../../router/api_routes';
    export default {
        name: "Index",
        components: {TopNavBar,PaginateTemplate,SideBar,DeleteModal,CopyRight,EstimateModal,
        ProcessingOverlay,SalesOrderModal},
        data(){
            return {
