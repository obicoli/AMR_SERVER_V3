    ...
    <div v-if="is_ready" class="width-100-pc float-left">
        <div class="width-100-pc float-left">
            ...
            <div class="row fullName mg-bottom-5 mg-left-30">
                <div class="inlineBlock width-30-pc text-right">
                    <label class="company-label text-right fs-12 width-100-pc">From Customer:&nbsp;&nbsp;</label>
                </div>
            ...
            <div class="row fullName mg-bottom-5 mg-left-30">
                <div class="inlineBlock width-30-pc text-right">
                    <label class="company-label text-right fs-12 width-100-pc">To Customer:&nbsp;&nbsp;</label>
                </div>
                <div class="inlineBlock width-70-pc">
                    <div class="dijitInline firstName dijitTextBox width-40-pc">
                        <vue-single-select
...
export default {
    props: ['refresh','report_options','customers','is_initializing'],
    data(){
        return {
            customer2: null,
            customer1: null,
