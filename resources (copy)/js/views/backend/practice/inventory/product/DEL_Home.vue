        ...
        <div class="wp-content">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35 justify-content-center bg-white">

                        <div class="col-md-12 col-lg-12 col-sm-12 padding-right-0 padding-left-0 bg-white min-height-100-vh max-width-1200 min-width-1200">
                                    ...
                                    <div class="pull pull-right width-100-pc">
                                        ...
                                        <div class="filters width-100-pc">
                                            ...
                                            <div class="width-30-pc pull-left">
                                                <search-item-field v-if="is_page_ready" v-on:itemFound="add_search_result" :products="practice_product_items" :show_label="false" :field_wdth="100" :tabulated_view="true" :rounded_px="2" :search_result_min_height="500" :search_result_width="1170"></search-item-field>
                                            </div>
                                    ...
                                    <table class="items table table-bordered table-hover more-ctm-table">
                                        ...
                                        <tbody v-if="practice_product_items.length > 0">
                                            ...
                                            <tr v-for="(practice_prod,index) in practice_product_items" :key="'practice_prod'+index">
                                                ...
                                                <product-modal v-if="is_page_ready" v-on:editedSuccessful="reloadItem" :initialUrl="initialUrl+'/'+practice_prod.id" :user_mode="'Edit'" :inventories="inventories" :form_data="practice_prod" :title="'Inventory Item'" :products_attributes="products_attributes" :modal_id="'product_item_modal_'+index"></product-modal>
                                            </tr>
                                        </tbody>
...
<script>
    ...
    import {PRODUCT_ITEMS_URL,ACCOUNTS_INITIALS,PRODUCT_ATTRIBUTES_URL} from '../../../../../router/api_routes';
    ...
    export default {
        ...
        methods: {
            ...
            reloadItem(item_to_reload){
                this.loadProductItem("hide");
                // for (let index = 0; index < this.practice_product_items.length; index++) {
                //     const element = this.practice_product_items[index];
                //     if( element.id === item_to_reload.id ){
                //         this.practice_product_items = removeElement(this.practice_product_items,element);
                //         this.practice_product_items.push(item_to_reload);
                //         break;
                //     }
                // }
            },
