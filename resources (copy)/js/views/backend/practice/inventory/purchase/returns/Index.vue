                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo min-height-100-vh">
                            <side-bar-purchase :scrollable="false" :width="true" :transparent="true" :title="'Purchase Return(PR)'" :active_num="'pr'"></side-bar-purchase>
                        </div>
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                <div class="width-100-pc padding-left-20 padding-right-20 padding-top-20 padding-bottom-20 mg-bottom-30">
                                    <div  class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                                        <button data-toggle="modal" data-target="#place_order_modal" type="button" class="btn combo-button combo-default">+ Create PR</button>
                                    ...
                                    <po-modal v-if="page_loaded" :modal_id="'place_order_modal'" :organ_data="organ_data" :form_data="form_data" :modal_title="'Purchase Order'" :practice_id="practice_id" :initializations="initializations" :user_mode="'Create'" v-on:poAdded="loadPo" v-on:requestVendorForm="showVendor"></po-modal>
                                ...
                                <div class="page-content bg-white min-height-100-vh padding-10">
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc padding-left-20 padding-right-20" role="grid">
                                        ...
                                        <table class="receipt-item-table-2 table table-bordered table-hover mg-top-5">
                                            <thead>
                                                <tr>
                                                    <th style="width: 3%;">TransID</th>
                                                    <th style="width: 10%;">Bill ID</th>
                                                    <th style="width: 10%;">Date</th>
                                                    <th style="width: 15%;">Supplier</th>
                                                    <th style="width: 10%;">Total</th>
                                                    <th style="width: 15%;">Cash Received</th>
                                                    <th style="width: 15%;">Receivable</th>
                                                ...
                                                <tr class="pointer-cursor" v-for="(purchase, index) in po_list" :key="'category_'+index">
                                                    ...
                                                    <td class="padded">
                                                        <div class="btn-group float-right" role="group" aria-label="Button group">
                                                            <!-- <a data-toggle="modal" data-target="#userModal" class="btn-link"></a>&nbsp;&nbsp; -->
                                                            <div class="btn-group" role="group">
...
<script>
    ...
    export default {
        ...
        ProcessingOverlay,PaginateTemplate,AddStockItemModal},
        data(){
            return {
                practice_id: '',
                po_list: [],
