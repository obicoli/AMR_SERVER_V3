                    ...
                    <div class="row mg-top-35">
                        ...
                        <div class="col-md-10 col-lg-10 col-sm-10 padding-right-0 padding-left-0 bg-foo">
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                        ...
                                        <table class="receipt-item-table-2 table table-bordered table-hover mg-top-5">
                                            ...
                                            <tbody v-if="tax_rates.length">
                                                <tr v-for="(category, index) in tax_rates" :key="'category_'+index" class="pointer-cursor">
                                                    ...
                                                    <tax-rate v-if="page_ready" :form_data="category" :initial_url="initial_url+'/'+category.id" :item_id="category.id" :user_mode="'Edit'" :title="'+ New Tax Rates'" :modal_id="'new_tax_modal_'+index"></tax-rate>
                                ...
                                <tax-rate v-if="page_ready" :user_mode="'Create'" :initial_url="initial_url" v-on:taxAdded="loadTax" :title="'+ New Tax Rate'" :modal_id="'new_tax_modal'"></tax-rate>
                            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadTax(show_overlay="show"){
                this.progress_overlay = show_overlay;
                get(this.initial_url)
                .then((res) => {
