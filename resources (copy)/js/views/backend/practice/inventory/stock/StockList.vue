        ...
        <div class="wp-content">
            <div class="row">
                ...
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull pull-left app-header width-40-pc">
                                    <h5>
                                        Inventory | <small>Available Stock List</small>&nbsp;&nbsp;&nbsp;
                                    </h5>
                                </div>
                                <div class="pull pull-right width-60-pc text-right padding-right-70">
                                    ...
                                    <a href="/inventory/items" class="top-links mg-right-10"><i class="fa fa-database"></i> Go to Items</a>
                                    <div class="btn-group float-right" role="group" aria-label="Button group with nested dropdown" style="box-shadow: inset 0 -1px 0 #DFDFDF;">
                                        <button data-toggle="modal" data-target="#product_item_modal" type="button" class="btn combo-button primary">+ New transaction</button>
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu right-0" aria-labelledby="btnGroupDrop">
                                                ...
                                                <a class="dropdown-item" href="#"> Create Purchase</a>
                                    ...
                                    <div class="box-header box-header-custom">
                                        <div class="pull pull-right width-100-pc">
                                            ...
                                            <div class="filters width-100-pc">
                                                ...
                                                <div class="width-20-pc pull-left">
                                                    <div class="btn-group float-left" role="group" aria-label="Button group with nested dropdown" style="box-shadow: inset 0 -1px 0 #DFDFDF;">
                                                        <button data-toggle="modal" data-target="#receive_stock_modal_id" type="button" class="btn combo-button combo-default">+ Receive Stock</button>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop">
                                                                <a data-toggle="modal" data-target="#adjust_stock_modal_id" class="dropdown-item fs-13 cl-444 pointer-cursor"> Adjust stock</a>
                                                                <a data-toggle="modal" data-target="#transfer_stock_modal_id" class="dropdown-item fs-13 cl-444 pointer-cursor"> Transfer stock</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="filter-block form-inline width-40-pc pull-right text-right">
                                                ...
                                                <div class="filter-block form-inline width-40-pc pull-right padding-left-10">
                                                    <span class="name">Status: </span>
                                                    <div class="filter-group input-group">
                                                        <span class="filter active">All</span>
                                                        <span class="filter">Low</span>
                                                        <span class="filter">Recent expired</span>
                    ...
                    <receive-stock-modal v-if="is_page_ready" :modal_id="'receive_stock_modal_id'" :modal_title="'Inventory Received'" :practice_id="practice_id" v-on:requestVendorForm="showVendor" ></receive-stock-modal>
                    <supplier-modal v-if="is_page_ready" :modal_id="'new_vendor_modal_id'" :user_mode="'Create'" :title="''"></supplier-modal>
                    <adjust-stock-modal v-if="is_page_ready" :modal_id="'adjust_stock_modal_id'" :modal_title="'Stock Adjustment'" :practice_id="practice_id" v-on:requestVendorForm="showVendor" ></adjust-stock-modal>
                    <transfer-stock-modal v-if="is_page_ready" :modal_id="'transfer_stock_modal_id'" :modal_title="'Stock Transfer'" :practice_id="practice_id" v-on:requestVendorForm="showVendor" ></transfer-stock-modal>
...
<script>
    ...
    import ReceiveStockModal from '../../../practice/partials/modals/product/ReceiveStockModal';
    import AdjustStockModal from '../../../practice/partials/modals/product/AdjustStockModal';
    import TransferStockModal from '../../../practice/partials/modals/product/TransferStockModal';
    import {get} from "../../../../../helpers/api";
    import AppInfo from "../../../../../helpers/config";
    import Auth from "../../../../../store/auth";
    import {formatMoney,removeElement} from "../../../../../helpers/functionmixin";
    import SupplierModal from '../../../practice/partials/modals/vendors/SupplierModal';

    export default {
        name: "Home",
        components: {TopNavBar, 
            SideBar,SideBarHr,ProductModal,ReceiveStockModal,
            ProcessingOverlay,DeleteModal,ViewProductItemModal,
            SupplierModal,AdjustStockModal,TransferStockModal
        },
        data(){
            return {
