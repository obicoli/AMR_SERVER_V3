                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height-wc">
                            <side-bar-inventory v-if="page_ready" :supplier="true" :scrollable="true" :width="true" :transparent="true" :active_num="'expenses'" :title="'Expenses'"></side-bar-inventory>
                        </div>
                                        ...
                                        <div v-else class="btn-group" role="group" aria-label="Button group">
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2_1'">
                                                    ...
                                                    <a class="dropdown-item pointer-cursor">Unbilled</a>
                                                    <a class="dropdown-item pointer-cursor">Invoiced</a>
                                                    <a class="dropdown-item pointer-cursor">Reimbursed</a>
                                                    <a class="dropdown-item pointer-cursor">Billable</a>
                                                    <a class="dropdown-item pointer-cursor">Non-billable</a>
                                                    <a class="dropdown-item pointer-cursor">With Receipts</a>
                                                    <a class="dropdown-item pointer-cursor">Without Receipts</a>
                                            ...
                                            <div class="padding-right-10 min-height-30 width-100-pc">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2'">
                                                        ...
                                                        <a class="dropdown-item pointer-cursor">Expense Account</a>
                                                        <a class="dropdown-item pointer-cursor">Vendor Name</a>
                                                        <a class="dropdown-item pointer-cursor">Paid Through</a>
                                                        ...
                                                        <a class="dropdown-item separator"></a>
                                                        <a class="dropdown-item pointer-cursor">Import Expense</a>
                                                        <a class="dropdown-item pointer-cursor">Export Expense</a>
                                                        <a class="dropdown-item separator"></a>
                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                <p class="fs-20">Time To Manage Your Expenses!</p><br>
                                                <small class="fs-14 cl-777">Create and manage expenses that are part of your organization’s operating costs.</small><br><br>
                                                <a data-toggle="modal" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-amref cl-white txt-uppercase">Record Expense</a>
                                            </div>

                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-20 padding-bottom-10">
                                                <img src="/assets/icons/dashboard/expense_cycle.png" class=" mg-bottom-20">
                                            </div>
