                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                ...
                                                <small class="fs-14 cl-777">Do you pay bills every so often? Start paying your vendors on time by creating recurring bills.</small><br><br>
                                                <a data-toggle="modal" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-amref cl-white txt-uppercase">Create a Recurring Bill</a>
                                            </div>
