                        ...
                        <div class="padding-left-0 bg-ced padding-right-0 content-calculated-height-50 col-md-8 col-lg-8 col-sm-8">
                            ...
                            <div class="box box-primary bg-white border-top-0 mg-bottom-0 content-calculated-height-50 border-bottom-0 no-shadowed">
                                <!-- ========================================================= -->
                                 <div  class="width-100-pc action-header padding-left-20 padding-top-10 padding-bottom-10">
                                    ...
                                    <div class="float-right width-80-pc text-right padding-right-30">
                                        ...
                                        <button type="button" data-toggle="modal" title="Edit Purchase Order" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-gray mg-left-2"><i class="fa fa-pencil"></i></button>
                                        <button type="button" @click="print('po_component_id_0')" class="btn btn-default btn-inventory btn-gray mg-left-2"><i class="fa fa-print"></i></button>
                                        <button class="btn btn-default btn-inventory btn-gray mg-left-2"><i class="fa fa-envelope-o"></i></button>
                                        <button class="btn btn-default btn-inventory btn-gray mg-left-2 mg-right-20"><i class="fa fa-paperclip"></i></button>

                                        <button v-if="page_loaded && check_status(purchase_order.status,PROCESS_STATUS.DRAFT)" type="button" data-toggle="modal" data-target="#change_po_status" class="btn btn-secondary banking-process-amref">Change Status</button>
                                        ...
                                        <div  class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop">
                                                    <a class="dropdown-item pointer-cursor" data-toggle="modal" data-target="#new_bill_id">Add Bill</a>
                                                    <a class="dropdown-item pointer-cursor" data-toggle="modal" data-target="#customerModal_0">Due Date</a>
                                                    <a class="dropdown-item pointer-cursor" data-toggle="modal" data-target="#customerModal_0">Change status</a>
                                                    <a class="dropdown-item separator"></a>
                                ...
                                <div class="page-content bg-white padding-left-0 height-scrollable">
                                 ...
                                 <po-modal v-if="page_loaded" :user_mode="'Create'" :filters="filters" v-on:poAdded="loadPos(false)" :suppliers="suppliers" :facilities="facilities" :customers="customers" :modal_id="'new_po_modal'" :modal_title="'New Purchase Order'"></po-modal>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    import {SUPPLIER_BILL_URL,PRODUCT_ITEMS_URL,SUPPLIER_URL,ACCOUNTS_ACCOUNT,PRACTICES_API,SUPPLIER_PO_URL} from '../../../../../../router/api_routes';
    import {createHtmlErrorString,formatMoney,paginator} from '../../../../../../helpers/functionmixin';
