                        ...
                        <div class="step row">
                            ...
                            <section class="userTypeSection col-md-4">
                                ...
                                <div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-4 col-md-4 col-sm-4 label-txt-right padding-right-0">
                                            <label class="fs-14 cl-888">Facility:<small class="cl-amref">*</small></label>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-7">
                                            <select @change="set_variable($event,'facility')" v-model="user_form.branch_id" required v-bind:class="{'form-control product-entry-input-field height-32':true,'attended_field':user_form.branch_id}">
                                                <option value="" disabled selected>-select-</option>
                                                <!-- <option :value="current_branch.id">{{current_branch.name}}</option> -->
                                                <option v-for="(practic, index) in initializations.facilities" :key="'hr_roles_'+index" :value="practic.id">{{practic.name}}</option>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-4 col-md-4 col-sm-4 label-txt-right padding-right-0">
                                            <label class="fs-14 cl-888">Department:<small class="cl-amref">*</small> </label>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-7">
                                            <select v-model="user_form.department_id" required v-bind:class="{'form-control product-entry-input-field height-32':true,'attended_field':user_form.department_id}">
                                                <option value="" disabled selected>-select-</option>
                                                <option v-for="(department, index) in initialization.departments" :key="'department'+index" :value="department.id">{{department.name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-lg-7 col-md-7 col-sm-7">
                                            <select v-model="user_form.store_id" v-bind:class="{'form-control product-entry-input-field height-32':true,'attended_field':user_form.branch_id}">
                                                <option value="" disabled selected>-select-</option>
                                                <option v-for="(store, index) in initialization.stores" :key="'department'+index" :value="store.id">{{store.name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-4 col-md-4 col-sm-4 label-txt-right padding-right-0">
                                            <label class="fs-14 cl-888">Sub Store: </label>
                                        </div>
                                        <div class="col-lg-7 col-md-7 col-sm-7">
                                            <select v-model="user_form.sub_store_id" v-bind:class="{'form-control product-entry-input-field height-32':true,'attended_field':user_form.branch_id}">
                                                <option value="" disabled selected>-select-</option>
                                                <option v-for="(sub_store, index) in initialization.sub_stores" :key="'department'+index" :value="sub_store.id">{{sub_store.name}}</option>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        name: "NewUserModal",
        props:['practice_id','initializations','form_data','initial_url','user_mode','modal_id','title','hr_roles','practices','departments'],
        data(){
            return {
                step: 0,
                step_continue: true,
        ...
        methods: {
            save_user(){
                ...
                post(PRACTICE_USERS_API,this.user_form)
                    .then((res) => {
