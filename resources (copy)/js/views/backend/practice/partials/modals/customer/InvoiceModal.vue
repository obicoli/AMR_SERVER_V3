                                        ...
                                        <div class="col-md-12 set-no-padding">
                                            ...
                                            <div class="width-100-pc float-left fs-12 bg-f4 padding-20">
                                                <div class="width-30-pc float-left fs-12">
                                                    ...
                                                    <div :hidden="invoice_type==='Recurring'" class="row fullName mg-bottom-5 mg-left-30">
                                                    ...
                                                    <div v-if="invoice_type==='Recurring'" class="row mg-bottom-5 mg-left-30">
                                                        <div class="col-lg-12 col-md-12">
                                                            <label class="fw-600 fs-14 text-right width-100-pc">Recurring Invoice Setup</label>
                                                            <div class="width-100-pc float-left doc-holder-2">
                                                                <div class="width-100-pc float-left mg-bottom-5">
                                                                    <div class="width-40-pc text-right float-left">
                                                                        <label class="company-label text-right fs-12 width-100-pc">Profile name:&nbsp;&nbsp;</label>
                                                                    </div>
                                                                    <div class="float-left width-60-pc">
                                                                        <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                            <input v-model="purchase_form.recurring.profile_name" class="width-100-pc report-filters-inputs" type="text">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="width-100-pc float-left mg-bottom-5">
                                                                    <div class="width-40-pc text-right float-left">
                                                                        <label class="company-label text-right fs-12 width-100-pc">Start Date:&nbsp;&nbsp;</label>
                                                                    </div>
                                                                    <div class="width-60-pc float-left">
                                                                        <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                            <datetime 
                                                                                v-model="purchase_form.recurring.start_date"
                                                                                :input-id="'date_input_recur1'"
                                                                                placeholder="select date"
                                                                                use12-hour
                                                                                :type="'date'"
                                                                                :format="{ year: 'numeric', month: 'numeric', day: 'numeric'}"
                                                                                :value="purchase_form.recurring.start_date"
                                                                                >
                                                                            </datetime>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="width-100-pc float-left mg-bottom-5">
                                                                    <div class="width-40-pc text-right float-left">
                                                                        <label class="company-label text-right fs-12 width-100-pc">Frequency:&nbsp;&nbsp;</label>
                                                                    </div>
                                                                    <div class="float-left width-60-pc">
                                                                        <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                            <select v-model="purchase_form.recurring.frequency" class="width-100-pc report-filters-inputs" >
                                                                ...
                                                                <div class="width-100-pc float-left mg-bottom-5">
                                                                    <div class="float-left width-40-pc text-right">
                                                                        <label class="company-label text-right fs-12 width-100-pc">End Date:&nbsp;&nbsp;</label>
                                                                    </div>
                                                                    <div class="float-left width-60-pc">
                                                                        <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                            <datetime 
                                                                                v-model="purchase_form.recurring.start_date"
                                                                                :input-id="'date_input_recur2'"
                                                                                placeholder="select date"
                                                                                use12-hour
                                                                                :type="'date'"
                                                                                :format="{ year: 'numeric', month: 'numeric', day: 'numeric'}"
                                                                ...
                                                                <div class="width-100-pc float-left mg-bottom-5">
                                                                    <div class="width-40-pc text-right float-left">
                                                                        <label class="company-label text-right fs-12 width-100-pc">Email To:&nbsp;&nbsp;</label>
                                                                    </div>
                                                                    <div class="float-left width-60-pc">
                                                                        <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                            <input v-model="purchase_form.recurring.email" class="width-100-pc report-filters-inputs" type="email">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="width-100-pc float-left mg-bottom-5">
                                                                    <div class="width-40-pc text-right float-left">
                                                                        <label class="company-label text-right fs-12 width-100-pc">Include CC?&nbsp;&nbsp;<input type="checkbox" v-model="purchase_form.recurring.cc_copy" class="pointer-cursor"></label>
                                                                    </div>
                                                                    <div class="float-left width-60-pc">
                                                                        <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                            <input :disabled="!purchase_form.recurring.cc_copy" v-model="purchase_form.recurring.cc_email" class="width-100-pc report-filters-inputs" type="email">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="width-30-pc float-left mg-left-30">
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-100-pc text-right">
                                                            <label class="fullname fw-600 fs-14 text-right">Invoice Details</label>
                                                        </div>
                                                    </div>
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Invoice No.&nbsp;&nbsp;</label>
                                                        </div>
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Sales Basis:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <input type="radio" v-model="purchase_form.sales_basis" value="Cash" class="pointer-cursor"> Cash&nbsp;&nbsp;
                                                            <input type="radio" v-model="purchase_form.sales_basis" value="Credit" class="pointer-cursor"> Credit&nbsp;&nbsp;
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Invoice Date:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <datetime 
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Invoice Due Date:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <datetime 
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">From:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <input :disabled="extractors" type="radio" v-model="purchase_form.extracted_from" value="Quotation" class="pointer-cursor"> Quotation&nbsp;&nbsp;
                                                            <input :disabled="extractors" type="radio" v-model="purchase_form.extracted_from" value="Sales Order" class="pointer-cursor"> Sales Order&nbsp;&nbsp;
                                                        </div>
                                                    </div>
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-30-pc text-right">
                                                            <label v-if="purchase_form.extracted_from==='Quotation'" class="company-label text-right fs-12 width-100-pc">Quote:&nbsp;&nbsp;</label>
                                                            <label v-if="purchase_form.extracted_from==='Sales Order'" class="company-label text-right fs-12 width-100-pc">Sales Order:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-70-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <vue-single-select
                                                                    name="maybe" v-if="purchase_form.extracted_from===DOC_QUOTE"
                                                                    placeholder=""
                                                                    you-want-to-select-a-post="ok"
                                                                ...
                                                                ></vue-single-select>
                                                                <vue-single-select v-if="purchase_form.extracted_from===DOC_SALES_ORDER"
                                                                    name="maybe"
                                                                    placeholder=""
                                                                    you-want-to-select-a-post="ok"
                                                                    v-model="selected_salesorder"
                                                                    out-of-all-these-posts="makes sense"
                                                                    :options="salesorders_list"
                                                                    a-post-has-an-id="good"
                                                                    the-post-has-a-title="make"
                                                                    option-label="display_as"
                                                                ></vue-single-select>
                                            ...
                                            <div class="width-100-pc float-left fs-12 bg-f4 padding-20 mg-bottom-20">
                                                <div v-if="purchase_form.sales_basis===PAYMENT_OPTIONS.CASH" class="width-25-pc float-left mg-right-20">
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-100-pc text-right">
                    ...
                    <div class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop">
                                <a :hidden="purchase_form.sales_basis===PAYMENT_OPTIONS.CASH" @click="save_invoice(FORM_ACTIONS.SAVE_DRAFT)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_DRAFT}}</a>
                                <a :hidden="purchase_form.sales_basis===PAYMENT_OPTIONS.CASH" @click="save_invoice(FORM_ACTIONS.SAVE_OPEN)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_OPEN}}</a>
                                <a @click="save_invoice(FORM_ACTIONS.SAVE_NEW)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_NEW}}</a>
                                <a @click="save_invoice(FORM_ACTIONS.SAVE_CLOSE)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_CLOSE}}</a>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        name: "InvoiceModal",
        props: ['modal_id','modal_title','customer_invoice_api','invoice_type','bank_accounts','taxations','estimate','salesorder','customer','customers','salespersons','currency','filters','payment_terms'],
        ...
        methods: {
            ...
            setForm(){
                ...
                if(this.customer){
                    ...
                    this.purchase_form.recurring.email = this.customer.email;
                }else{
                ...
                if(this.filters){
                    ...
                    this.purchase_form.recurring.start_date = format_lunox_date(this.filters.today);
                    this.purchase_form.recurring.end_date = format_lunox_date(this.filters.today);
                }
                if(this.selected_customer){
                    ...
                    this.purchase_form.recurring.email = this.selected_customer.email;
                }
                //
                if(this.selected_estimate){
                    this.estimates_list = [];
            ...
            save_invoice(action_taken){
                ...
                post(this.customer_invoice_api,this.purchase_form)
                    .then((res) => {
                        if(res.data.status_code === 200) {
                            this.processing = false;
                            //this.purchase_form = reset_forms(this.purchase_form);
                            this.$emit('create-invoice-event');
        ...
        mounted(){
            ...
            if(this.invoice_type){
                this.purchase_form.invoice_type = this.invoice_type;
            }
            this.setForm();
        }
