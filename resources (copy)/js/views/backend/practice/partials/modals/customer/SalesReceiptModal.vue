                                        ...
                                        <div class="col-md-12 set-no-padding">
                                            ...
                                            <div class="width-100-pc float-left fs-12 bg-f4 padding-20">
                                                ...
                                                <div class="width-30-pc float-left mg-left-30">
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-100-pc text-right">
                                                            <label class="fullname fw-600 fs-14 text-right">Sales Receipt Details</label>
                                                        </div>
                                                    </div>
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Sales Receipt No.&nbsp;&nbsp;</label>
                                                        </div>
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Sales Receipt date:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <datetime 
                                            ...
                                            <div class="width-100-pc float-left fs-12 bg-f4 padding-20 mg-bottom-20">
                                                ...
                                                <div class="width-25-pc float-left mg-right-20">
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-100-pc text-right">
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-30-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Deposit to:&nbsp;&nbsp;</label>
                                                        </div>
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        ...
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <input disabled @keyup="amend_qty($event,'cash_paid',0,0,0,index)" v-model="purchase_form.payment.net_total" required v-bind:class="{'height-32':true,'custom-attended-field':purchase_form.payment.payment_method}" type="number">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                ...
                                                <div class="width-30-pc float-right fs-12 bg-f4 summary-total padding-10 mg-bottom-20">
                                                    ...
                                                    <div v-if="purchase_form.taxation_option===TAX_OPTIONS.INCLUSIVE" class="row fullName mg-bottom-5">
                                                        <div class="inlineBlock width-50-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Sales Tax:&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-45-pc text-right">
                                                    ...
                                                    <div class="row fullName mg-bottom-5">
                                                        <div class="inlineBlock width-50-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Total Discount<span v-if="purchase_form.overal_discount">({{format_money(purchase_form.overal_discount_rate)+'%'}})</span>&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-45-pc">
                                                            <label class="company-label text-right fs-12 width-100-pc txt-capitalize fw-600">{{currency+' '+format_money(purchase_form.total_discount)}}</label>
                                                        </div>
                                                    </div>
                                                    <div class="row fullName mg-bottom-5">
                                                        <div class="inlineBlock width-50-pc text-right">
                    ...
                    <div class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop">
                                <!-- <a @click="save_sales_receipt(FORM_ACTIONS.SAVE_DRAFT)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_DRAFT}}</a>
                                <a @click="save_sales_receipt(FORM_ACTIONS.SAVE_OPEN)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_OPEN}}</a> -->
                                <a @click="save_sales_receipt(FORM_ACTIONS.SAVE_NEW)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_NEW}}</a>
                                <a @click="save_sales_receipt(FORM_ACTIONS.SAVE_CLOSE)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_CLOSE}}</a>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        props: ['modal_id','modal_title','sales_receipt_api','taxations','estimate','customer','bank_accounts','customers','salespersons','currency','filters','payment_terms'],
        ...
        data(){
            return {
                ...
                purchase_form: {
                    ...
                    terms_condition: "Goods once sold are not returnable",
        ...
        methods: {
            ...
            save_sales_receipt(action_taken){
                ...
                post(this.sales_receipt_api,this.purchase_form)
                    .then((res) => {
                        if(res.data.status_code === 200) {
                            this.processing = false;
                            this.$emit('create-sales-receipt-event');
