                                ...
                                <div class="col-lg-8 col-md-8 padding-left-0 padding-right-0">
                                    ...
                                    <div class="width-100-pc bg-eee padding-left-20 padding-right-20 padding-top-10 padding-bottom-10">
                                        <div class="row fullName margin-5">
                                            ...
                                            <div class="inlineBlock width-40-pc mg-bottom-5 mg-right-5">
                                        ...
                                        <div class="row fullName margin-5">
                                            ...
                                            <div class="inlineBlock width-20-pc mg-right-5">
                                                <span class="fs-13 fw-600">Sales Receipt date</span>
                                                <div class="dijitInline firstName dijitTextBox width-100-pc">
                                        ...
                                        <div class="row fullName margin-5">
                                            ...
                                            <div class="inlineBlock width-30-pc mg-bottom-5 mg-right-5">
                                                <span class="fs-13 fw-600">Reference no.</span><a class="btn-link float-right">Cc/Bcc</a>
                                                <div class="dijitInline firstName dijitTextBox width-100-pc">
                                    ...
                                    <div id="inner_invoice_area">
                                        ...
                                        <div class="col-md-12 set-no-padding">
                                                    ...
                                                    <div class="float-right width-300-px">
                                                        <div class="row fullName margin-5">
                                                            ...
                                                            <div class="inlineBlock width-70-pc mg-bottom-5 mg-right-3 padding-top-25">
                                                                <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                    <input class="width-100-pc report-filters-inputs" list="tax_list" type="text" placeholder="Choose a customer">
                                            ...
                                            <div class="width-300-px mg-top-30 padding-right-30 float-right">
                                                ...
                                                <div class="row form-group mg-bottom-10">
                                                    <div class="col-lg-12 col-md-12 label-txt-right padding-right-0">
                                                        <label class="fs-13 fw-600 cl-444">Includes VAT Agency @ 0.6% on 0.00	: Ksh00.00</label>
                                                    </div>
                                                </div>
                                                <!-- <div class="row form-group mg-bottom-10">
                                                ...
                                                <div class="row form-group mg-bottom-10">
                                                    <div class="col-lg-12 col-md-12 label-txt-right padding-right-0">
                                                        <label class="fs-20 fw-600 cl-444">Amount received: Ksh{{format_money(purchase_form.total_grand)}}</label>
                                                    </div>
                                                </div>

                                                <div class="row form-group mg-bottom-10">
                                                    <div class="col-lg-12 col-md-12 label-txt-right padding-right-0">
                                                        <label class="fs-20 fw-600 cl-444">Balance Due: Ksh{{format_money(purchase_form.total_grand)}}</label>
                                                    </div>
                                                </div>
