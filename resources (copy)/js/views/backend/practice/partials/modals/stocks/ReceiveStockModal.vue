                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 padding-left-0">
                                    ...
                                    <div class="width-40-pc float-left padding-top-10 padding-bottom-10">
                                        ...
                                        <div class="row fullName margin-5">
                                            <div class="inlineBlock width-30-pc mg-bottom-2">
                                                <label class="fs-13 fw-600 width-100-pc text-right padding-right-3">Ref No:</label>
                                            </div>
                                            <div class="inlineBlock width-70-pc mg-bottom-2">
                                                <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                    <input type="text" v-model="purchase.ref_number" required v-bind:class="{'ctm-attended-field':purchase.date_received}">
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    export default {
        ...
        components: {SupplierModal,SearchItemField},
        data(){
            return {
                current_branch: {},
                processing: false,
