                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 padding-left-0">
                                    ...
                                    <div class="width-40-pc float-left padding-top-10 padding-bottom-10">
                                        <div class="row fullName margin-5">
                                            <div class="inlineBlock width-30-pc mg-bottom-2">
                                                <label class="fs-13 fw-600 width-100-pc text-right padding-right-3">Adjustment#:</label>
                                            </div>
                                            <div class="inlineBlock width-70-pc mg-bottom-2">
                                                <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                    <a class="cl-amref fw-600 fs-12 pointer-cursor">(Auto Number)</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row fullName margin-5">
                                            <div class="inlineBlock width-30-pc mg-bottom-5">
                                                <label class="fs-13 fw-600 width-100-pc text-right padding-right-3">Type</label>
                                            </div>
                                            <div class="inlineBlock width-70-pc mg-bottom-5">
                                                <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                    <select v-model="purchase.adjust_type" v-bind:class="{'width-100-pc report-filters-inputs':true,'ctm-attended-field':purchase.adjust_type}">
                                                        <option disabled selected value="">-select-</option>
                                                        <option>Add(Inward)</option>
...
<script>
    ...
    export default {
        name: 'StockAjustmentModal',
        props: ['modal_id','modal_title','practice_id','purchase','initializations','organ_data','stock_source','default_adjust'],
