...
<body>
	...
	<section>
		<div class="container">
			<div class="details clearfix" style="width: 100%;">
				<div class="client left">
          <div class="title">PO TO</div>
          <p class="name">{{$mailing_address['first_name']}} {{$mailing_address['other_name']}}</p>
          <p class="name">{{$mailing_address['company']}}</p>
					<p>{{$mailing_address['address']}},</p>
					<p>{{$mailing_address['postal_code']}}, {{$mailing_address['city']}}, {{$mailing_address['country']}}</p>
					<a href="mailto:john@example.com">{{$mailing_address['email']}}</a>
				</div>
				<div class="data right">
					<div class="title">PO Number: #{{$order_data['po_number']}}</div>
					<div class="date">
