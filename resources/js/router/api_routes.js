...
export const PRODUCT_TAX_URL = `${ BASE_API_URL }/practices/taxations`;
export const TRANSACTION_DOCUMENTS_API = `${ BASE_API_URL }/transaction/documents`;
export const PRACTICE_DOCUMENTS_API = `${ BASE_API_URL }/practices/documents`;
