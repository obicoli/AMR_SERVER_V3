...
const router = new VueRouter({
    ...
    routes: [
        ...
        {  path: ADMINSTRATIVE.CHANGE_PASSWORD, component: PasswordChange, meta: { title:'Change Password', authenticatedUser: true } },
        {  path: ADMINSTRATIVE.MY_ACCOUNT, component: MyAccount, meta: { title:'My Profile', authenticatedUser: true } },
        ...
        { path: '/403', component: Err403, meta: {  title: Config.app_data.app_name+' | 403-Forbidden'} },
    ]
});
