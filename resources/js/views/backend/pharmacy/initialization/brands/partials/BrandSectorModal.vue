<template>
    ...
    <form @submit.prevent="save_brand_sector">
        <div class="modal-content">
            <div class="modal-header">
                <h4 v-if="user_mode==='Create'" class="cl-grey"><i class="fa fa-plus-circle"></i> Add Brand Sector:</h4>
            ...
            <div class="modal-body">
                <div class="row form-group mg-bottom-10">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7">
                        <input type="text" v-model="form.name" placeholder="e.g Amoxicillin trihydrate" required class="form-control product-entry-input-field">
                    </div>
                </div>
                    ...
                    .then((res) => {
                        if(res.data.status_code === 200) {
                            ...
                            if (this.user_mode === 'Edit') {
                                this.$emit('brandSectorEdited');
                            }else {
                                this.refresh_form();
                                this.$emit('brandSectorAdded')
                            }
                        }
