            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row form-group mg-bottom-10">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <datalist id="supplier_list">
                                <option v-for="account_holder in account_holders" :data-value="account_holder.id" :value="account_holder.name"></option>
                            </datalist>
                        </div>
                    </div>
                    ...
                    <div class="row form-group mg-bottom-10">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control product-entry-input-field">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-info btn-flat margin btn-lg pull-right fs-14" value="true" ><i class="fa fa-floppy-o" aria-hidden="true"></i> Save Purchase</button>
                            </div>
                        </div>
                    </div>
                </div>
