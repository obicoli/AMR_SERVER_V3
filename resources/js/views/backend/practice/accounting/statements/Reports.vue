                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        <div v-if="page_ready" class="row justify-content-center">
                                                        ...
                                                        <div class="width-45-pc float-left mg-top-15">
                                                            <div class="btn-group" role="group" aria-label="Button group">
                                                                <div class="btn-group" role="group">
                                                                    <a :id="'btnGroupDrop2_1'" class="dropdown-toggle fs-16 pointer-cursor fw-600" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                        {{report_options.report_name}} Report
                                                                    </a>
                                                                    <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2_1'">
                                                                        <router-link v-for="(key,item) in ACCOUNT_REPORTS" :hidden="is_initializing" :to="REPORT_WEB_URL+'?type='+key" class="dropdown-item pointer-cursor" :key="'REPORTS'+item">{{key}}</router-link>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div v-if="default_report_filter" class="col-md-8 col-lg-8 padding-right-0 border-bottom">
                                                <report-filter :report_options="report_options" :categories="categories" :chart_of_accounts="chart_of_accounts" :refresh="false" :customers="customers" :is_initializing="is_initializing" @report-options-event="loadReport(report_options)"></report-filter>
                                            </div>
                                                        ...
                                                        <div class="width-100-pc float-left collapse multi-collapse bg-f4 padding-10" id="multiCollapseExample2">
                                                            <div class="row justify-content-center">
                                                                <div class="col-md-9 col-lg-9 padding-right-0 border-bottom">
                                                                    <report-filter :report_options="report_options" :categories="categories" :chart_of_accounts="chart_of_accounts" :refresh="true" :customers="customers" :is_initializing="is_initializing" @report-options-event="loadReport(report_options)"></report-filter>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    ...
    import {CUSTOMERS_API,SUPPLIER_REPORTS_API,CHART_OF_ACCOUNTS,CHART_OF_ACCOUNTS_TYPES} from '../../../../../router/api_routes';
    ...
    export default {
        ...
        ProcessingOverlay,ReportFilter,CopyRight},
        data(){
            return {

                ACCOUNT_REPORTS: ACCOUNTING.ACCOUNT_REPORTS,
                ...
                REPORTS: TRANSACTION_TYPES.CUSTOMER_REPORTS,
                REPORT_WEB_URL: ACCOUNTING_WEB_ROUTES.REPORTS,
                report_options: {
                    status: '',
                    report_name: null,
                    category: '',
                    ...
                    incl_credit_notes_and_ajustment: false,
                    trx_type: null,
                    document_status: '',
                    minimun_balance: ''
                },
        ...
        methods: {
            ...
            loadAccounts(){
                ...
                .then((res) => {
                    if(res.data.status_code === 200) {
                        this.chart_of_accounts = res.data.results.data;
                        this.filters = res.data.results.filters;
                        this.pagination = res.data.results.pagination;
                        this.page_ready  = true;
                        this.is_initializing = false;
