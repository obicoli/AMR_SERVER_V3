                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        <div v-if="page_ready" class="row justify-content-center">
                                                            ...
                                                            <div class="btn-group" role="group" aria-label="Button group">
                                                                <div class="btn-group" role="group">
                                                                    ...
                                                                    <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2_1'">
                                                                        <router-link v-for="(item,key) in BANKING_REPORTS" :hidden="is_initializing" :to="REPORTS_URL+'?type='+item" class="dropdown-item pointer-cursor" :key="key+'key__ggg'">{{item}}</router-link>
                                            ...
                                            <div v-if="default_report_filter" class="col-md-7 col-lg-7 padding-right-0 border-bottom">
                                                <report-filter :report_opt="report_options" :reported_data="reported_data" :banks="bank_accounts" :tax_returns="tax_returns" :vat_types="vat_types" :refresh="false" :report_type="report_type" @report-data-event="setData(reported_data)" @report-options-event="setOpt(report_options)"></report-filter>
                                            </div>
...
<script>
    ...
    import {AC_TYPES,ACCOUNTING,TRANSACTION_TYPES,VAT_OPTIONS,BANKING} from "../../../../../helpers/process_status";
    import {ACCOUNTS_TAX_RETURNS,ACCOUNTS_TAXATIONS,BANKING_ACCOUNTS_URL} from '../../../../../router/api_routes';
    import {ACCOUNTING_WEB_ROUTES,BANKS_WEB_ROUTES} from '../../../../../router/web_routes';
    export default {
        name: "BankReports",
        components: {TopNavBar,SideBar,
        ProcessingOverlay,CopyRight,ReportFilter},
        data(){
            return {
                BANKING_REPORTS: BANKING.REPORTS,
                REPORTS_URL: BANKS_WEB_ROUTES.REPORTS,
                page_setting: true,
                as_at: null,
        ...
        mounted() {
            ...
            this.report_options.report_name = this.report_type;
