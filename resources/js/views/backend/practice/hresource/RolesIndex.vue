                    ...
                    <div class="settings-header shadowed  main-heading bg-foo">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="pull pull-right app-header width-40-pc text-right">
                        ...
                        <div class="col-md-10 col-lg-10 col-sm-10 padding-right-0 padding-left-0 bg-foo min-height-100-vh">
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                ...
                                <div class="width-100-pc padding-left-20 padding-right-20 padding-top-20 padding-bottom-20 mg-bottom-30">
                                    ...
                                    <add-role v-if="page_loaded" :modal_title="'New User Role'" :initial_url="initialUrl" :modal_id="'add_role_modal'" :user_mode="'Create'" :branch_id="practice_id" :form_data="role_form" v-on:roleAdded="loadRoles"></add-role>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            loadRoles() {
                this.progress_overlay = "show";
                get(AppInfo.app_data.server_domain+this.initialUrl+'/practice/'+this.practice_id)
                .then((res) => {
                    if(res.data.status_code === 200) {
            ...
            load_Permissions() {
                this.progress_overlay = "show";
                get(AppInfo.app_data.server_domain+AppInfo.app_data.apis.permissions)
                    .then((res) => {
                        if(res.data.status_code === 200) {
