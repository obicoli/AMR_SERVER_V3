                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height">
                            <side-bar-customer :scrollable="false" :width="true" :transparent="true" :title="'Invoices'" :active_num="'invoices'"></side-bar-customer>
                        </div>
                            ...
                            <div class="estimate-list width-100-pc content-calculated-height">
                                <div class="estimate-list-head">
                                    ...
                                    <div class=" width-50-pc float-right">
                                        ...
                                        <invoice-modal :modal_id="'modal_id_invoice'" :modal_title="'Invoice'"></invoice-modal>
                                    </div>
                                </div>
...
<script>
    ...
    import EstimateView from './partials/InvoiceView';
    ...
    export default {
        name: "Index",
        components: {TopNavBar,SideBar,ConfirmModal,PaginateTemplate,CustomerModal,EstimateView,InvoiceModal,
