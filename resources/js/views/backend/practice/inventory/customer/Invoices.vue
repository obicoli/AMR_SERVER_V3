                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height-wc">
                            <side-bar-inventory v-if="page_ready" :customer="true" :scrollable="true" :width="true" :transparent="true" :active_num="'invoices'" :title="'Invoices'"></side-bar-inventory>
                        </div>
                                        ...
                                        <div v-else class="btn-group" role="group" aria-label="Button group">
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2_1'">
                                                    ...
                                                    <a class="dropdown-item pointer-cursor">Partially Paid</a>
                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                <p class="fs-20">Get paid!</p><br>
                                                <small class="fs-14 cl-777">We don't want to boast too much, but sending amazing invoices and getting paid is easier than ever. Go ahead! Try it yourself.</small><br><br>
                                                <a data-toggle="modal" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-amref cl-white txt-uppercase">New Invoice</a>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-20 padding-bottom-10">
                                                ...
                                                <ul class="custom-list">
                                                    <li class="title">In the Invoices section, you can:</li>
                                                    <li>Create and send amazing invoices</li>
