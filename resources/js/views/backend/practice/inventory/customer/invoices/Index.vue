                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Button group">
                                                            <div class="btn-group" role="group">
                                                                <a :id="'btnGroupDrop2_1'" class="dropdown-toggle fs-14 pointer-cursor fw-600 txt-uppercase" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    {{default_filter}} Tax Invoices ({{pagination.total}})
                                                                </a>
                                                ...
                                                <div class="width-100-pc float-left mg-top-30 mg-bottom-50">
                                                    <div v-if="page_ready && customer_invoices.length===0" class="width-100-pc float-left mg-top-10 mg-bottom-50 text-center">
                                                        <div class="width-100-pc text-center float-left">
                                                            <a class="fs-15 txt-uppercase cl-444 fw-600">Customer Invoice</a><br>
                                                            <a class="fs-14 cl-444">Get paid!</a><br>
                                                            <small class="fs-13 cl-777">We don't want to boast too much, but sending amazing invoices and getting paid is easier than ever. Go ahead! Try it yourself.</small><br><br>
                                                            <a data-toggle="modal" data-target="#create_invoice_modal" class="btn btn-secondary banking-process-amref">Create Invoice</a>
                                                        </div>
                                                        <div class="width-100-pc text-center float-left mg-top-20">
                                                            <img src="/assets/icons/dashboard/invoice_cycle.png" class=" mg-bottom-20">
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table class="table banking-transaction table-hover mg-bottom-5">        
                                                                ...
                                                                <tbody v-for="(customerinvoice,index) in customer_invoices" :key="'chart_of_accounts_'+index">
                                                                    <tr>
                                                                        ...
                                                                        <router-link tag="td" :to="INVOICES_URL+'/'+customerinvoice.id+'/view'" class="somepad pointer-cursor">
                                                                        ...
                                                                        <router-link tag="td" :to="INVOICES_URL+'/'+customerinvoice.id+'/view'" class="somepad pointer-cursor text-right fw-600">
...
<script>
    ...
    import {CUSTOMERS_SALES_ORDERS_API,CUSTOMERS_INVOICES_API,PRODUCT_TAX_URL,CHART_OF_ACCOUNTS, CUSTOMERS_API,CUSTOMERS_TERMS_API,CUSTOMERS_ESTIMATES_API, BANKING_ACCOUNTS_URL} from '../../../../../../router/api_routes';
    export default {
        name: "Index",
        components: {TopNavBar,PaginateTemplate,SideBar,DeleteModal,CopyRight,EstimateModal,SalesOrderModal,
        ProcessingOverlay,InvoiceModal},
        data(){
            return {
                ...
                customer_invoices: [],
                default_filter: 'All',
                default_api: CUSTOMERS_INVOICES_API+'?page=1&invoice_type=Non-Recurring',
            ...
            filterItems(filter_by='All'){
                switch (filter_by) {
                    ...
                    case PROCESS_STATUS.PARTIAL_PAID:
                        ...
                        this.default_api = CUSTOMERS_INVOICES_API+'?page='+this.pagination.current_page+'&filter_by='+this.default_filter+'&invoice_type=Non-Recurring';
                        break;
                    case "Page":
                        if(this.default_filter==='All'){
                            this.default_api = CUSTOMERS_INVOICES_API+'?page='+this.pagination.current_page+'&invoice_type=Non-Recurring';
                        }else{
                            this.default_api = CUSTOMERS_INVOICES_API+'?page='+this.pagination.current_page+'&filter_by='+this.default_filter+'&invoice_type=Non-Recurring';
                        }
                        break;
