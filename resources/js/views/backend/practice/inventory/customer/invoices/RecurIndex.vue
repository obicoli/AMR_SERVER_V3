                                                ...
                                                <div class="width-100-pc float-left mg-top-30 mg-bottom-50">
                                                    <div v-if="page_ready && customer_invoices.length===0" class="width-100-pc float-left mg-top-10 mg-bottom-50 text-center">
                                                        <div class="width-100-pc text-center float-left">
                                                            <a class="fs-15 txt-uppercase cl-444 fw-600">Recurring Invoice</a><br>
                                                            <a class="fs-14 cl-444">Create. Set. Repeat.</a><br>
                                                            <small class="fs-13 cl-777">Set up a profile to periodically create and send invoices to your customers.</small><br><br>
                                                        ...
                                                        <div class="width-100-pc text-center float-left mg-top-20">
                                                            <img src="/assets/icons/dashboard/recur_invoice_cycle.png" class=" mg-bottom-20">
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table class="table banking-transaction table-hover mg-bottom-5">        
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th style="width:13%;">Profile name</th>
                                                                ...
                                                                <tbody v-for="(customerinvoice,index) in customer_invoices" :key="'chart_of_accounts_'+index">
                                                                    <tr>
                                                                        ...
                                                                        <router-link tag="td" :to="RECUR_INVOICES+'/'+customerinvoice.id+'/view'" class="somepad pointer-cursor">
                                                                        ...
                                                                        <router-link tag="td" :to="RECUR_INVOICES+'/'+customerinvoice.id+'/view'" class="somepad pointer-cursor">
                                                                            {{customerinvoice.recurring.profile_name}}
                                                                        </router-link>
                                                                        <!-- <router-link tag="td" :to="RECUR_INVOICES+'/'+customerinvoice.id+'/view'" class="somepad pointer-cursor">
                                                                        ...
                                                                        <router-link tag="td" :to="RECUR_INVOICES+'/'+customerinvoice.id+'/view'" class="somepad pointer-cursor">
                                                                            ...
                                                                            <a v-else-if="customerinvoice.status[customerinvoice.status.length-1].status===PROCESS_STATUS.ACTIVE" class="documentStatus closed">{{PROCESS_STATUS.ACTIVE}}</a>
                                                                        ...
                                                                        <router-link tag="td" :to="RECUR_INVOICES+'/'+customerinvoice.id+'/view'" class="somepad pointer-cursor text-right fw-600">
