    ...
    export default {
        ...
        data(){
            return {
                ...
                default_filter: 'All',
                default_api: CUSTOMERS_INVOICES_API+'?page=1',
            ...
            filterBills(filter_by='All'){
                switch (filter_by) {
                    ...
                    case PROCESS_STATUS.PARTIAL_PAID:
                        ...
                        this.default_api = CUSTOMERS_INVOICES_API+'?page='+this.pagination.current_page+'&filter_by='+this.default_filter;
                        break;
                    case "Page":
                        if(this.default_filter==='All'){
                            this.default_api = CUSTOMERS_INVOICES_API+'?page='+this.pagination.current_page;
                        }else{
                            this.default_api = CUSTOMERS_INVOICES_API+'?page='+this.pagination.current_page+'&filter_by='+this.default_filter;
                        }
                        break;
