                ...
                <div class="invoice invoice-2 invoice-body mg-left-5 mg-right-10 mg-top-5 invoice-border zero-border width-900-px padding-20">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 pull-right text-center">
                            <h2 class="invoice-title txt-uppercase fs-20 cl-787887"><b>Invoice</b></h2>
                        ...
                        <div class="col-md-12 col-sm-12 mg-top-35">
                            <table class="sales-table">
                                <tr class="title">
                                    ...
                                    <td class="text-center">Ship Via</td>
                                    <td class="text-center">Terms</td>
                                    <td class="text-center">Due Date</td>
                                </tr>
                                <tr class="info">
                                    <td class="text-center cl-787887">{{estimate.trans_number}}</td>
                        ...
                        <div class="col-md-12 mg-top-20">
                            ...
                            <table class="sales-table width-100-pc">
                                ...
                                <!-- <tr class="info">
                                    ...
                                    <td class="no-bd txt-uppercase fw-600" colspan="3">
                                ...
                                <tr class="title">
                                    <td colspan="5" class="text-center">Thank you for your business</td>
                                </tr>
                            </table>
                        </div>
                    </div>
