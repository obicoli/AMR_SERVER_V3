                ...
                <div class="invoice invoice-2 invoice-body mg-left-5 mg-right-10 mg-top-5 invoice-border zero-border width-900-px padding-20">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 pull-left">
                            <h2 class="invoice-title txt-uppercase fs-20"><b>Sales Order</b></h2>
                        ...
                        <div class="col-md-4 col-sm-4 pull-right text-center report-header padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 mg-top-35">
                            <table class="sales-table">
                                <tr class="title">
                                    <td class="text-center">Salesperson</td>
                                    <td class="text-center">Job</td>
                                    <td class="text-center">Shipping method</td>
                                    <td class="text-center">Shipping Terms</td>
                                    <td class="text-center">Delivery Date</td>
                                    <td class="text-center">Payment Terms</td>
                                    <td class="text-center">Due Date</td>
                                </tr>
                                <tr class="info">
                                    <td class="text-center cl-787887">{{estimate.trans_status[estimate.trans_status.length-1].signatory.first_name}}</td>
                                    <td class="text-center cl-787887"></td>
                                    <td class="text-center cl-787887"></td>
                                    <td class="text-center cl-787887"></td>
                                    <td class="text-center cl-787887">{{estimate.estimate_date}}</td>
                                    <td class="text-center cl-787887">{{estimate.customer.customer_term.name}}</td>
                                    <td class="text-center cl-787887">{{estimate.estimate_date}}</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="col-md-12 mg-top-20">
                            ...
                            <table class="sales-table width-100-pc">
                                <tr class="title">
                                    ...
                                    <td class="text-right" style="width:10%;">Discount</td>
                                ...
                                <tr v-for="(est_item,est_index) in estimate.items" class="info" :key="'estimate_'+est_index">
                                    ...
                                    <td class="no-top-bottom-bd text-right">{{formatMoneys(est_item.line_discount)}}</td>
                                    <td class="no-top-bottom-bd text-right fw-600">{{formatMoneys(est_item.line_total-est_item.line_discount)}}</td>
                                </tr>
                                <tr class="info">
                                    <td style="width:50%;" class="txt-italic">{{estimate.notes}}</td>
                                    <td class="txt-uppercase fw-600" colspan="4"><a class="float-left">Total Discount:</a><a class="float-right"> {{formatMoneys(estimate.discount_allowed)}} {{ACCOUNTING.CURRENCEY}} </a></td>
                                </tr>
                                <tr v-if="estimate.discount_allowed" class="info">
                                    <td style="width:50%;" class="no-bd"></td>
