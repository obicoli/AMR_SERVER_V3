                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 col-lg-10 padding-right-0 border-bottom">
                                                <div :hidden="sales_receipts.length===0 && default_filter==='All'" class="width-100-pc float-left">
                                                ...
                                                <div class="width-100-pc float-left mg-top-30 mg-bottom-50">
                                                    <div v-if="page_ready && sales_receipts.length===0" class="width-100-pc float-left mg-top-10 mg-bottom-50 text-center">
                                                        <div class="width-100-pc text-center float-left">
                                                            <a class="fs-15 txt-uppercase cl-444 fw-600">Sales Receipts</a><br>
                                                            <a class="fs-14 cl-444">How are sales receipts different?</a><br>
                                                            <small class="fs-13 cl-777">If a customer pays for something before you’ve had a chance to create an invoice, save yourself a step and use a sales receipt</small><br><br>
                                                            <a data-toggle="modal" data-target="#new_sales_receipt_modal" class="btn btn-secondary banking-process-amref">New Sales Receipt</a>
                                                        </div>
                                                    ...
                                                    <div v-else-if="page_ready && sales_receipts.length>0" class="width-100-pc float-left mg-top-30 mg-bottom-50">
                                                        ...
                                                        <div id="po_list_id_0" class="width-100-pc float-left">
                                                            <table class="table banking-transaction table-hover mg-bottom-5">        
                                                                ...
                                                                <tbody v-for="(salesr,index) in sales_receipts" :key="'chart_of_accounts_'+index">
                                                                    <tr>
                                                                        <td class="somepad">
                                                                        ...
                                                                        <router-link tag="td" :to="SALES_RECEIPTS+'/'+salesr.id+'/view'" class="somepad pointer-cursor">
                                                                        ...
                                                                        <router-link tag="td" :to="SALES_RECEIPTS+'/'+salesr.id+'/view'" class="somepad pointer-cursor text-right fw-600">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-12 col-lg-12 padding-right-0 border-bottom">
                                                <invoice-modal v-if="page_ready" :modal_title="'New Customer Invoice'" :invoice_type="'Non-Recurring'" :customers="customers" :modal_id="'create_invoice_modal'" :bank_accounts="bank_accounts" :payment_terms="payment_terms" :filters="filters" :taxations="taxations" :currency="currency" :customer_invoice_api="CUSTOMERS_SALES_RECEIPT_API" @create-salesorder-event="goTo(SALES_RECEIPTS)"></invoice-modal>
                                                <sales-order-modal v-if="page_ready" :modal_title="'New Sales Order'" :customers="customers" :modal_id="'new_sales_order_modal'" :payment_terms="payment_terms" :filters="filters" :taxations="taxations" :currency="currency" :sales_order_api="CUSTOMERS_SALES_RECEIPT_API" @create-salesorder-event="loadSalesorders(true)"></sales-order-modal>
...
<script>
    ...
    import {CUSTOMERS_SALES_RECEIPT_API,CUSTOMERS_INVOICES_API,PRODUCT_TAX_URL,CHART_OF_ACCOUNTS, CUSTOMERS_API,CUSTOMERS_TERMS_API,CUSTOMERS_ESTIMATES_API, BANKING_ACCOUNTS_URL} from '../../../../../../router/api_routes';
    export default {
        name: "Index",
        components: {TopNavBar,PaginateTemplate,SideBar,DeleteModal,CopyRight,EstimateModal,SalesOrderModal,
        ProcessingOverlay,InvoiceModal,SalesReceiptModal},
        data(){
            return {
            ...
            loadSalesReceipts(show_progress=false){
                ...
                .then((res) => {
                    if(res.data.status_code === 200) {
                        ...
                        console.info(this.sales_receipts);
