                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        <div v-if="page_ready" class="row justify-content-center">
                                            ...
                                            <div v-if="default_report_filter" class="col-md-8 col-lg-8 padding-right-0 border-bottom">
                                                <report-filter :report_options="report_options" :refresh="false" :customers="customers" :is_initializing="is_initializing" @report-options-event="loadReport(report_options)"></report-filter>
                                            </div>
                                                        ...
                                                        <div class="width-100-pc float-left collapse multi-collapse bg-f4 padding-10" id="multiCollapseExample2">
                                                            <div class="row justify-content-center">
                                                                <div class="col-md-9 col-lg-9 padding-right-0 border-bottom">
                                                                    <report-filter :report_options="report_options" :refresh="true" :customers="customers" :is_initializing="is_initializing" @report-options-event="loadReport(report_options)"></report-filter>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    ...
    import {CUSTOMERS_API,SUPPLIER_REPORTS_API} from '../../../../../../router/api_routes';
