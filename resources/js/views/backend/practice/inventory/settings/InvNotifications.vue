                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo min-height-100-vh">
                            <side-bar-inv-settings v-if="page_ready" :scrollable="false" :width="true" :transparent="true" :active_el="'Notification'" :title="'Notification Settings'"></side-bar-inv-settings>
                        </div>
                                ...
                                <div class="page-content bg-white min-height-100-vh padding-10">
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc padding-left-20 padding-right-20 mg-top-45" role="grid">
                                        <div class="width-50-pc pull-left mg-bottom-10">
                                            <router-link :to="INVENTORY_WEB_ROUTES.INV_SET_STORES" class="btn-default-md pointer-cursor">Email</router-link>
                                            <router-link :to="INVENTORY_WEB_ROUTES.INV_SET_SUB_STORES" class="btn-default-md pointer-cursor">SMS</router-link>
                                            <router-link :to="INVENTORY_WEB_ROUTES.INV_SET_SUB_STORES" class="btn-approved-md pointer-cursor">Settings</router-link>
                                        ...
                                        <!-- <div class="width-20-pc pull-right mg-bottom-10">
                                            <div class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                                                <button data-toggle="modal" data-target="#new_category_modal" type="button" class="btn combo-button combo-default">+ New</button>
                                        ...
                                        <!-- <table class="receipt-item-table-2 table table-bordered table-hover mg-top-5">
                                            ...
                                            <tbody v-if="categories.length">
                                                <tr v-for="(category, index) in categories" :key="'category_'+index">
                                                    ...
                                                    <category-modal v-if="page_ready" :form_data="category" :INITIAL_URL="initial_url+'/'+category.id" :item_id="category.id" :user_mode="'Edit'" :title="'+ New Category'" :modal_id="'new_category_modal_'+index" v-on:categoryAdded="loadCategories" v-on:categoryEdited="replace_edited" :practice_id="practice_id"></category-modal>
                                                </tr>
                                            </tbody>
                                            <tbody v-if="!categories.length">
                                                <tr>
                                                    <td colspan="5" class="cl-amref text-center fs-16 padding-top-20 padding-bottom-20">No category to dispalay</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
...
<script>
    ...
    import {PRODUCT_ATTRIBUTES_URL,PRODUCT_CATEGORIES_URL} from '../../../../../router/api_routes';
    import {INVENTORY_WEB_ROUTES} from '../../../../../router/web_routes';
    export default {
        name: "Index",
        components: {TopNavBar, SideBar,SideBarInvSettings,
        DeleteModal,CategoryModal,GeneralImportModal,
        ...
        methods: {
            ...
            loadCategories(){
                this.categories = [];
                this.progress_overlay = "show";
                get(PRODUCT_CATEGORIES_URL+'/practice/'+this.practice_id+'?page='+this.pagination.current_page)
                .then((res) => {
                    if(res.data.status_code === 200) {
