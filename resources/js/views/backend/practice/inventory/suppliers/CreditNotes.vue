                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height-wc">
                            <side-bar-inventory v-if="page_ready" :supplier="true" :scrollable="true" :width="true" :transparent="true" :active_num="'debit_notes'" :title="'Debit Notes'"></side-bar-inventory>
                        </div>
                                            ...
                                            <div class="padding-right-10 min-height-30 width-100-pc">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2'">
                                                        ...
                                                        <a class="dropdown-item pointer-cursor">Vendor</a>
                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                <p class="fs-20">You deserve some credit too.</p><br>
                                                <small class="fs-14 cl-777">Create vendor credits and apply them to multiple bills when buying stuff from your vendor.</small><br><br>
                                                <a data-toggle="modal" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-amref cl-white txt-uppercase">Create Vendor Credits</a>
                                            </div>
