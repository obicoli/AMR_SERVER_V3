                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo content-calculated-height-wc">
                            <side-bar-inventory v-if="page_ready" :supplier="true" :scrollable="true" :width="true" :transparent="true" :active_num="'receivables'" :title="'Purchases'"></side-bar-inventory>
                        </div>
                                        ...
                                        <div v-else class="btn-group" role="group" aria-label="Button group">
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" :aria-labelledby="'btnGroupDrop2_1'">
                                                    ...
                                                    <a class="dropdown-item pointer-cursor">Pending</a>
                                                    <a class="dropdown-item pointer-cursor">Received</a>
                                                    <a class="dropdown-item pointer-cursor">Not Received</a>
                                    ...
                                    <div class="dgrid dgrid-grid ui-widget dgrid-03 mg-bottom-30 universal-grid border-ccc" role="grid">
                                        ...
                                        <div v-else class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-30 padding-top-30">
                                                <p class="fs-20">Receive Purchase.</p><br>
                                                <small class="fs-14 cl-777">Partially or fully receive your purchase orders to track actual receipt of goods.</small><br><br>
                                                <a data-toggle="modal" data-target="#new_po_modal" class="btn btn-default btn-inventory btn-amref cl-white txt-uppercase">Create receivable</a>
                                            </div>

                                            <div class="col-md-12 col-lg-12 bg-white text-center border-bottom mg-top-20 padding-bottom-10">
                                                <img src="/assets/icons/dashboard/receivable.png" class="mg-bottom-20 width-60-pc">
                                            </div>
