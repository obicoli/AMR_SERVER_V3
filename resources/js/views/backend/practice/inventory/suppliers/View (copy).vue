                            ...
                            <div class="estimate-list width-100-pc content-calculated-height-50">
                                ...
                                <div class="estimate-list-body height-scrollable-body">
                                    <table class="width-100-pc">
                                        <tbody v-for="(supplie,index) in suppliers" tag="tbody" class="pointer-cursor" :key="'estimate_list_'+index">
                                            <tr class="parent">
                                                <td style="width:10%"><input type="checkbox"> </td>
                                                <router-link tag="td" :to="'/vendors/'+supplie.id+'/overview'" style="width:55%">{{supplie.first_name}} {{supplie.last_name}}</router-link>
                                                <router-link tag="td" :to="'/vendors/'+supplie.id+'/overview'" style="width:35%" class="text-right fs-12 cl-444 fw-600"></router-link>
                                            </tr>
                                            <router-link tag="tr" :to="'/vendors/'+supplie.id+'/overview'" class="child">
                                                <td style="width:10%" class="text-right"></td>
                                                <td class="fs-12 cl-787887 fw-600" style="width:55%">
                                                    {{supplie.currency.currency_sympol}}{{formatMoneys(supplie.account.balance)}}
                                                </td>
                                ...
                                <!-- ========================================================= -->
                                 <div  class="width-100-pc action-header padding-left-20 padding-top-10 padding-bottom-10">
                                        ...
                                        <div  class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop">
                                                    ...
                                                    <a class="dropdown-item pointer-cursor" data-toggle="modal" data-target="#customerModal_0">Purchase Order</a>
                                    ...
                                    <div class="width-100-pc mg-top-45 content-links">
                                        <supplier-header v-if="page_loaded" :supplier="supplier" :active="'overview'"></supplier-header>
                                        <!-- <router-link to="/" class="cl-blue-link fs-13">Overview</router-link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <router-link to="/" class="cl-blue-link fs-13">Comments</router-link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <router-link to="/" class="cl-blue-link fs-13">Purchases</router-link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <router-link to="/" class="cl-blue-link fs-13">Related List</router-link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <router-link to="/" class="cl-blue-link fs-13">Mails</router-link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <router-link to="/" class="cl-blue-link fs-13 active">Statement</router-link> -->
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div  class="width-100-pc mg-top-45 text-center">
                                                    ...
                                                    <small class="fs-12">From 01 OCT 2019 to 31 OCT 2019</small>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div  class="width-100-pc mg-top-30 mg-left-10 padding-20 text-center hidden-overflow box-shadow">
                                                    ...
                                                    <div class="width-50-pc float-right text-right mg-top-20">
                                                        ...
                                                        <small class="fs-13"><span class="cl-444 fw-600">Date: </span>From 01 OCT 2019 to 31 OCT 2019</small><br>
                                                        <small class="fs-13"><span class="cl-444 fw-600">Account No: </span> XDE4321</small>
                                                    </div>
                                                    <div class="width-40-pc text-right float-right mg-top-20">
                                                        <table class="sales-table">
                                                            ...
                                                            <tr class="info">
                                                                ...
                                                                <td class="no-bd text-right">KES 00.00</td>
                                                            </tr>
                                                            <tr class="info">
...
<script>
    ...
    import {CUSTOMERS_ESTIMATES_API,ACCOUNTS_INITIALS,CUSTOMERS_API,PRODUCT_ITEMS_URL,SUPPLIER_URL} from '../../../../../router/api_routes';
    ...
    export default {
        name: "Index",
        components: {TopNavBar,SideBar,ConfirmModal,PaginateTemplate,SupplierHeader,
        SideBarInventory,ProcessingOverlay,CommonLinks,SearchDatabaseFormControl,EstimateModal},
        data(){
            return {
