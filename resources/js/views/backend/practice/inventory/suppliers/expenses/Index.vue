                                                ...
                                                <div class="width-100-pc float-left mg-top-45">
                                                    ...
                                                    <div v-if="page_ready && payments.length===0 && default_filter==='All' && is_initializing===false && processing===false" class="width-100-pc float-left mg-top-10 mg-bottom-50 text-center">
                                                        <div class="width-100-pc text-center float-left">
                                                            <a class="fs-15 txt-uppercase cl-444 fw-600">Time To Manage Your Expenses!</a><br>
                                                            <small class="fs-13 cl-777">Create and manage expenses that are part of your organization’s operating costs.</small><br><br>
                                                            <a data-toggle="modal" data-target="#new_bill_id" class="btn btn-secondary banking-process-amref">Record Expense</a>
                                                        </div>
