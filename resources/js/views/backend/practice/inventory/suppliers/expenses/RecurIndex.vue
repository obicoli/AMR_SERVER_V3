                                                ...
                                                <div class="width-100-pc float-left mg-top-45">
                                                    ...
                                                    <div v-if="page_ready && payments.length===0 && default_filter==='All' && is_initializing===false && processing===false" class="width-100-pc float-left mg-top-10 mg-bottom-50 text-center">
                                                        <div class="width-100-pc text-center float-left">
                                                            ...
                                                            <small class="fs-13 cl-777">Create recurring expenses to handle and pay for stuff you spend on periodically.</small><br><br>
                                                            <a data-toggle="modal" data-target="#new_bill_id" class="btn btn-secondary banking-process-amref">New Recurring Expense</a>
                                                        </div>
                                                        <div class="width-100-pc text-center float-left mg-top-20">
                                                            <img src="/assets/icons/dashboard/recuring_expense.png" class=" mg-bottom-20">
                                                        </div>
                                                    </div>
                                                    <copy-right></copy-right>
                                                    <expense-modal v-if="page_ready" :taxations="taxations" :inventories="inventories" :accounts="accounts" :bank_accounts="bank_accounts" :filters="filters" :billable="false" :payment_terms="payment_terms" :currency="currency" :bill_api="SUPPLIER_BILL_URL" :billable_type="'PO'" :suppliers="suppliers" :order="bill" :modal_id="'new_bill_id'" :modal_title="'New Recurring Expense'" @create-bill-event="loadRecurExpenses"></expense-modal>
                                                </div>
                                            </div>
...
<script>
    ...
    import ExpenseModal from "../../../partials/modals/vendors/ExpenseModal";
    ...
    import {SUPPLIER_PAYMENTS_API,SUPPLIER_BILL_URL} from '../../../../../../router/api_routes';
    export default {
        name: "RecurIndex",
        components: {TopNavBar,PaginateTemplate,SideBar,DeleteModal,CopyRight,ExpenseModal,
        ...
        methods: {
            ...
            loadRecurExpenses(show_progress){
