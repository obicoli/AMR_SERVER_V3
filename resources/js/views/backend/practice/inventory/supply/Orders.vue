                ...
                <div class="col-md-12 col-lg-12 col-sm-12 padding-left-0">
                    ...
                    <div class="row mg-top-35">
                        ...
                        <div class="col-md-2 col-lg-2 col-sm-2 padding-right-0 bg-foo min-height-100-vh">
                            <side-bar-supply :scrollable="false" :width="true" :transparent="true" :title="'Supply'" :active_num="'orders'"></side-bar-supply>
                        </div>
                            ...
                            <div class="box box-primary bg-white border-top-0 border-bottom-0 no-shadowed">
                                ...
                                <div class="width-100-pc padding-left-20 padding-right-20 padding-top-20 padding-bottom-20 mg-bottom-30">
                                    <div  class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                                        <button data-toggle="modal" data-target="#create_purchase_modal" type="button" class="btn combo-button combo-default">+ Create Order</button>
                                        ...
                                        <table class="receipt-item-table-2 table table-bordered table-hover mg-top-5">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 10%;">Facility/Customer</th>
                                            ...
                                            <tbody v-if="!supply_list.length">
                                                <tr>
                                                    <td colspan="9" class="cl-amref text-center fs-16 padding-top-20 padding-bottom-20">No order to dispalay</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
