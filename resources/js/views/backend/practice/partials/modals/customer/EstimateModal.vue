                                        ...
                                        <div class="col-md-12 set-no-padding">
                                            ...
                                            <div class="width-100-pc float-left fs-12 bg-f4 padding-20">
                                                ...
                                                <div class="width-30-pc float-left mg-left-30">
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-100-pc text-right">
                                                            <label class="fullname fw-600 fs-14 text-right">Estimate Details</label>
                                                        </div>
                                                    </div>
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Estimate No.&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <input v-model="purchase_form.credit_number" disabled type="text" class="custom-attended-field">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row fullName mg-bottom-5 mg-left-30 mg-top-5">
                                                        ...
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <input v-model="purchase_form.reference_number" v-bind:class="{'height-32':true}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Estimate Date:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <datetime 
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-40-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Due Date:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-60-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <datetime 
                                                    ...
                                                    <div class="row fullName mg-bottom-5 mg-left-30">
                                                        <div class="inlineBlock width-80-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Create a retainer invoice for this estimate:&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-20-pc">
                                                            <input type="checkbox" v-model="purchase_form.retainer_invoice" class="pointer-cursor">
                                                        </div>
                                                    </div>
                                                    <div v-if="purchase_form.retainer_invoice" class="row fullName mg-bottom-5 mg-left-30 mg-top-5">
                                                        <div class="inlineBlock width-70-pc text-right">
                                                            <label class="company-label text-right fs-12 width-100-pc">Percentage to be collected(%):&nbsp;&nbsp;</label>
                                                        </div>
                                                        <div class="inlineBlock width-30-pc">
                                                            <div class="dijitInline firstName dijitTextBox width-100-pc">
                                                                <input v-model="purchase_form.retainer_percentage" v-bind:class="{'height-32':true}" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="btn-group float-right" role="group" aria-label="Button group with nested dropdown">
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop">
                                <a @click="save_estimate(FORM_ACTIONS.SAVE_DRAFT)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_DRAFT}}</a>
                                <a @click="save_estimate(FORM_ACTIONS.SAVE_OPEN)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_OPEN}}</a>
                                <a @click="save_estimate(FORM_ACTIONS.SAVE_NEW)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_NEW}}</a>
                                <a @click="save_estimate(FORM_ACTIONS.SAVE_CLOSE)" class="dropdown-item pointer-cursor"> {{FORM_ACTIONS.SAVE_CLOSE}}</a>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        props: ['modal_id','modal_title','estimate_api','taxations','customers','salespersons','currency','filters','payment_terms'],
        ...
        methods: {
            ...
            save_estimate(action_taken){
                ...
                post(this.estimate_api,this.purchase_form)
                    .then((res) => {
                        if(res.data.status_code === 200) {
                            this.processing = false;
                            //this.purchase_form = reset_forms(this.purchase_form);
                            this.$emit('create-estimate-event');
