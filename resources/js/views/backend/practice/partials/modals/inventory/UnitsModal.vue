                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-11 col-md-11">
                            <div class="width-100-pc float-left mg-top-20">
                                ...
                                <div class="width-100-pc float-left fullName mg-bottom-5">
                                    <div class="float-left width-40-pc text-right">
                                        <label class="company-label text-right fs-12 width-100-pc">Symbol:&nbsp;&nbsp;</label>
                                    </div>
                                    <div class="float-left width-50-pc">
                                        <div class="dijitInline firstName dijitTextBox width-100-pc">
                                            <input v-model="form.slug" type="text" class="text-right-force" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="width-100-pc float-left fullName mg-bottom-5">
        ...
        methods: {
            ...
            setItemForm(){
                if(this.user_mode === 'Edit'){
                    ...
                    this.form.slug = this.form_model.slug;
