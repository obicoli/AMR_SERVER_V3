                    ...
                    <div  class="modal-body">
                        <div class="row form-group mg-bottom-10">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7">
                                <input type="text" placeholder="e.g Kilogram" required v-model="form.name" class="form-control product-entry-input-field">
                            </div>
                        </div>
                        ...
                        <div class="row form-group mg-bottom-10">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-7">
                                <input type="text" placeholder="e.g Kg" required v-model="form.slug" class="form-control product-entry-input-field">
                            </div>
                        </div>
