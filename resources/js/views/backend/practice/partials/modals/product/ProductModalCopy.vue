                    ...
                    <form @submit.prevent="save_item">
                        ...
                        <div  class="modal-body padding-top-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 padding-left-0 padding-right-0">
                                    <div class="bg-white border-top-0 border-bottom-0 border-radius-0">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 dijitTextBox">
                                                <select :disabled="prog_form.processing" required v-model="item_form.item_type" v-bind:class="{'width-95-pc':true,'attended_field':item_form.item_type}">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 dijitTextBox">
                                                <select :disabled="prog_form.processing" required v-model="item_form.unit_measure" v-bind:class="{'width-95-pc':true,'attended_field':item_form.unit_measure}">
                                                    ...
                                                    <option v-for="(product_uni, index) in products_attributes.units" :value="product_uni.id" :selected="item_form.unit_measure === product_uni.slug" :key="'product_uni'+index">{{product_uni.name}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                    ...
                                    <div class="bg-white border-top-0 border-bottom-0 border-radius-0">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                ...
                                                <label v-for="(taxes_charg,index) in products_attributes.taxes" class="fs-13 width-100-pc mg-top-5" :key="'taxes_charg'+index">
                                                    <input type="checkbox" v-model="item_form.tax_per_unit" :value="taxes_charg.id"> {{taxes_charg.tax_name}}@{{taxes_charg.tax_value}}%
                                                </label>
                                                ...
                                                <div class="add-charge">
                                                    ...
                                                    <a v-if="!add_charge" @click="toggleBtn(true)" class="cl-blue-link pointer-cursor fs-14">+add new</a>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            save_tax(){
                this.prog_form.tax_prog = true;
                this.item_form.practice_id = this.practice_id;
                post(PRODUCT_TAX_URL, this.tax_form)
                .then((res) => {
                    if(res.data.status_code === 200) {
                        this.prog_form.tax_prog = false;
