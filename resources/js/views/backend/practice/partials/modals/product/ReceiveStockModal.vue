                    ...
                    <div class="row">
                            ...
                            <div class="width-100-pc padding-10" style="background-color: #f7f7f7!important;">
                                <div class="filter-block form-inline">
                                    <div class="filter-group input-group">
                                        <span class="filter active">Drugs</span>
                        ...
                        <div class="col-lg-9">
                            <div class="row">
                                ...
                                <div class="col-lg-4 padding-10 mg-left-10 mg-top-10">
                                    <div class=" width-100-pc">
                                        <div class="row fullName margin-5">
                                            <div class="inlineBlock width-30-pc">
                                                <label class="fullname" for="firstName">From: </label>
                                            </div>
                                            <div class="inlineBlock width-70-pc">
                                                <div class="dijitInline firstName dijitTextBox width-100-pc" id="widget_dijit_form_TextBox_2" role="presentation" widgetid="dijit_form_TextBox_2">
                                                    <select @change="setSource($event)" class="width-100-pc height-27">
                                                        <option disabled selected value="">-select-</option>
                                                        <option value="store">Facility Stores</option>
                                        ...
                                        <div v-if="source_vendor" class="row fullName margin-5">
                                            <div class="inlineBlock width-100-pc">
                                                <label class="fullname" for="firstName">Vendor:</label>
                                                <div class="dijitInline firstName dijitTextBox width-100-pc" role="presentation" widgetid="dijit_form_TextBox_2">
                                                    <select class="width-100-pc height-27">
                                                        <option disabled selected value="">-select-</option>
                                                        <option>Abc Corp Suppliers</option>
                                                        <option>GSK Corp</option>
                                                    </select>
                                                    <a @click="requestVendorForm" class="btn-link">+ New Vendor</a>
                                                </div>
                                            </div>
                                        </div>

                                        <div v-if="source_store" class="row fullName margin-5">
                                ...
                                <div class="col-lg-4 bg-greenish padding-10 mg-left-10 mg-top-10">
                                    <div class=" width-100-pc">
                                        ...
                                        <div class="row fullName margin-5">
                                            ...
                                            <div class="inlineBlock width-50-pc">
                                                <label class="fullname" for="firstName">Date Received</label>
                                                <div class="dijitInline firstName dijitTextBox width-100-pc" id="widget_dijit_form_TextBox_2" role="presentation" widgetid="dijit_form_TextBox_2">
                                                    <input type="date" class="width-100-pc height-27">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div  id="inner_invoice_area" class="col-md-12 padding-left-0 padding-right-0">
                                    <div class="col-md-12 padding-left-0 padding-right-0">
                                        <table class="table table-striped table-bordered table_height_set">
                                            <thead>
                                                <tr>
                                                    <th class="cl-444 bg-greenish" style="width: 25%">Item</th>
                                                    <th class="cl-444 bg-greenish" style="width: 13%">Quantity</th>
                                                    <th class="cl-444 bg-greenish" style="width: 23%">Batch/Lot No</th>
                                                    <th class="cl-444 bg-greenish" style="width: 10%">Vendor Item No</th>
                                                    <th class="cl-444 bg-greenish" style="width: 15%">Unit Cost(KES)</th>
                                                    <th class="cl-444 bg-greenish" style="width: 12%">Total Cost</th>
                                                    <th class="cl-444 bg-greenish" style="width: 2%"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr v-for="(item, index) in purchase_form.items" :key="'items_'+index">
                                                    ...
                                                    <td>
                                                        <input type="text" v-model="purchase_form.items[index].batch_number" required class="form-control product-entry-input-field height-27" placeholder="Batch Number">
                                                        <div v-if="purchase_form.items[index].batch_number" class="expiry-content mg-top-5">
                                                            <span class="cl-444 fs-14 fw-600">Expiry:</span>
                                                            <select required class="bg-white height-27 border-radius-2 border-ccc no-shadowed" style="width: 35%;">
                                                    ...
                                                    <td>
                                                        <input type="text" v-model="purchase_form.items[index].vendor_item_number" class="form-control product-entry-input-field height-27">
                                                    </td>
                                                    <td>
                                                        <input type="number" step="any" v-model="purchase_form.items[index].unit_cost" class="form-control product-entry-input-field height-27">
                                                    </td>
                                                    <td>
                                                        <input type="number" disabled class="form-control product-entry-input-field height-27">
                                                    </td>
                                                    <td>
