<template>
    <ul v-bind:class="{'list-group flex-column d-inline-block submenu submenu-custom':true,'scrollable-menu':scrollable,'width-100-pc':width}">
        ...
        <li v-bind:class="{'list-group-item items-lists pl-4':true,'active':active_link==='branches'}">
            <router-link to="/" class="">Company</router-link>
        </li>

        <li v-bind:class="{'list-group-item items-lists pl-4':true,'active':active_link==='branches'}">
            <router-link to="/" class="">Facilities</router-link>
        </li>

        <li @click="link_user('/facility/settings/departments',6)" v-bind:class="{'list-group-item items-lists pl-4':true,'active':active_link===6}">
        ...
        <li v-bind:class="{'list-group-item items-lists pl-4':true,'active':active_link===3}">
