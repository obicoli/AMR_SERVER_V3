                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" class="txt-para">
                                                {{$other_data['custom_message']}}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" class="txt-para">
                                                {{$other_data['custom_message_2']}}
                                            </td>
                                        </tr>

                                        <tr>
                                            <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" class="txt-para">
                                                Need help? We have answers the way you want them! Check out our Answer Center for quick and easy self-service solutions for all your important questions. Visit www.afyamkononi.com/support.
                                            </td>
                                        </tr>
